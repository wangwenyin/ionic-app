...
(function(){ 'use strict';
     ...
     * @returns {*}
     */
    namespace.isStyleEqual = function(source, destination) {
...
(function(){ 'use strict';
    ...
    proto.unselect = function() {
        ...
        if (fireEv) {
            this.dispatchEvent({ type: namespace.EVENT_MARKUP_DESELECT, markupId: selectedId });
        }
    };
    ...
    proto.creationEnd = function(isCancelling) {
        ...
        this.creating = false;
        this.dispatchEvent({ type: namespace.EVENT_EDITMODE_CREATION_END, creationCancelled: !!isCancelling });
    };
...
(function(){ 'use strict';
    ...
    proto.setStyle = function(style) {
        var stylesEqual = namespaceUtils.isStyleEqual(style, this.style);
    ...
    proto.updateStyle = function(sizeUpdateRequired) {
        ...
        if (this.highlightChanged()) {
            ...
            namespaceUtils.updateMarkupTextSvgClipper(text, this.size.x, this.size.y);
            namespaceUtils.updateMarkupTextSvgHitarea(text, this.size.x, this.size.y, editor);
    ...
    proto.getBoundingRect = function() {
        ...
        var margin = width + namespaceUtils.EDIT_FRAME_DEFAULT_MARGIN;
...
(function(){ 'use strict';
    ...
    proto.rebuildTextSvg = function(value) {
        ...
        namespaceUtils.setAttributeToMarkupSvg(text, 'text-rendering', 'auto');
        namespaceUtils.setAttributeToMarkupSvg(text, 'fill', strokeColor);
...
(function(){ 'use strict';
    ...
    proto.updateStyle = function(sizeUpdateRequired) {
        ...
        if (this.highlightChanged()) {
            ...
            namespaceUtils.updateMarkupTextSvgBackground(shape, this.size.x, this.size.y, fillColor);
            namespaceUtils.updateMarkupTextSvgClipper(shape, this.size.x, this.size.y);
            namespaceUtils.updateMarkupTextSvgHitarea(shape, this.size.x, this.size.y, editor);
        }
    };
...
(function(){ 'use strict';
    ...
    MarkupsCore.prototype.changeEditMode = function(editMode) {
        ...
        editMode.addEventListener(namespace.EVENT_EDITMODE_CREATION_END, function(){
            ...
            //yuanmh 20181201  批注画完回调
            if(this.CreationEndEventCallback) {
                this.CreationEndEventCallback.call();
            }
        }.bind(this));
    ...
    /**
     * yuanmh 20181201 增加注册标注画完的回调
     */
    MarkupsCore.prototype.registerCreationEndEvent = function(callback) {
        this.CreationEndEventCallback = callback;
    }
    /**
...
(function(){ 'use strict';
    ...
    function EditModeCallout(editor) {
        ...
        var helper = new namespace.EditorTextInput(this.viewer.container, this.editor, false, 'Text', 360);
...
(function(){ 'use strict';
    ...
    function EditModeText(editor) {
        ...
        var helper = new namespace.EditorTextInput(this.viewer.container, this.editor, false, 'Text', 260);
        helper.addEventListener(helper.EVENT_TEXT_CHANGE, this.onHelperTextChange.bind(this), false);
        helper.addEventListener(helper.EVENT_TEXT_SET_ACTIVE, this.onHelperSetActive.bind(this), false);
        helper.addEventListener(helper.EVENT_TEXT_SET_INACTIVE, this.onHelperSetActive.bind(this), false);
...
(function(){ 'use strict';
    ...
    */
    ...
    proto.setEditFrame = function() {
        if (this.editor.editFrame.markup && this.textMarkup) {
