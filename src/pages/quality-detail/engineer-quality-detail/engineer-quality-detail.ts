...
import { QualityProcessRecord, QualityServiceProxy, FileServiceProxy, QualityDayCheck } from '../../../shared/service-proxies-hdApp/service-proxies-hdApp';
...
/**
 * Generated class for the EngineerQualityDetailPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-engineer-quality-detail',
  templateUrl: 'engineer-quality-detail.html',
})
export class EngineerQualityDetailPage {
  ...
  checkInfo() {
    this.navCtrl.push('AppointPage', { id: this.id, type: 1 });
  }
  ...
  sendEmp() {
    this.navCtrl.push('AppointConstructionPage', { id: this.id, type: '1' });
  }
}
