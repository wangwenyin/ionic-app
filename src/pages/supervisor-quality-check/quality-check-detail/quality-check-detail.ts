...
import { QualityKPICheck, QualityServiceProxy, FileServiceProxy, QualityProcessRecord } from '../../../shared/service-proxies-hdApp/service-proxies-hdApp';
...
/**
 * Generated class for the QualityCheckDetailPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-quality-check-detail',
  templateUrl: 'quality-check-detail.html',
})
export class QualityCheckDetailPage {
