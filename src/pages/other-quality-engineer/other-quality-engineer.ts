...
/**
 * Generated class for the OtherQualityEngineerPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-other-quality-engineer',
  templateUrl: 'other-quality-engineer.html',
})
export class OtherQualityEngineerPage {
  ...
  initParams() {
    ...
    this.dealParams['state.in'] = ['1', '2', '3', '4'];
    this.checkParams['state.in'] = ['5', '6'];
