...
export class HrmsServiceProxy {
     ...
     * @return Success
     */
    getAllGroups(): Observable<ListResultDtoOfGetGroupsOutput> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/GetAllGroups";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<ListResultDtoOfGetGroupsOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<ListResultDtoOfGetGroupsOutput>><any>Observable.throw(response_);
        });
    }

    protected processGetAllGroups(response: Response): Observable<ListResultDtoOfGetGroupsOutput> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? ListResultDtoOfGetGroupsOutput.fromJS(resultData200) : new ListResultDtoOfGetGroupsOutput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<ListResultDtoOfGetGroupsOutput>(<any>null);
    }

    /**
     * @return Success
     */
    insertGroup(groupName: string): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/InsertGroup?";
    ...
    protected processInsertGroup(response: Response): Observable<boolean> {
        const status = response.status;
     ...
     * @return Success
     */
    updateGroupName(id: number, groupName: string): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/UpdateGroupName?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        if (groupName !== undefined)
            url_ += "groupName=" + encodeURIComponent("" + groupName) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processUpdateGroupName(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processUpdateGroupName(response_);
    ...
    protected processUpdateGroupName(response: Response): Observable<boolean> {
        const status = response.status;
    ...
    deleteGroup(id: number): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/DeleteGroup?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processDeleteGroup(response: Response): Observable<boolean> {
        const status = response.status;
     ...
     * @return Success
     */
    insertGroupIdToUser(userId: number, groupId: number): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/InsertGroupIdToUser?";
        if (userId !== undefined)
            url_ += "userId=" + encodeURIComponent("" + userId) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processInsertGroupIdToUser(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processInsertGroupIdToUser(response_);
    ...
    protected processInsertGroupIdToUser(response: Response): Observable<boolean> {
        const status = response.status;
     ...
     * @return Success
     */
    getGroupCounts(groupId: number, isDelete: number, searchValue: string, sorting: string, maxResultCount: number, skipCount: number): Observable<PagedResultDtoOfGetTenantUsersOutput> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/GetGroupCounts?";
        if (groupId !== undefined)
            url_ += "GroupId=" + encodeURIComponent("" + groupId) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetGroupCounts(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetGroupCounts(response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfGetTenantUsersOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<PagedResultDtoOfGetTenantUsersOutput>><any>Observable.throw(response_);
        });
    }

    protected processGetGroupCounts(response: Response): Observable<PagedResultDtoOfGetTenantUsersOutput> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? PagedResultDtoOfGetTenantUsersOutput.fromJS(resultData200) : new PagedResultDtoOfGetTenantUsersOutput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<PagedResultDtoOfGetTenantUsersOutput>(<any>null);
    }

    /**
     * @return Success
     */
    getAllCompany(): Observable<ListResultDtoOfGetCompanyOutput> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/GetAllCompany";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<ListResultDtoOfGetCompanyOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<ListResultDtoOfGetCompanyOutput>><any>Observable.throw(response_);
        });
    }

    protected processGetAllCompany(response: Response): Observable<ListResultDtoOfGetCompanyOutput> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? ListResultDtoOfGetCompanyOutput.fromJS(resultData200) : new ListResultDtoOfGetCompanyOutput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<ListResultDtoOfGetCompanyOutput>(<any>null);
    }

    /**
     * @return Success
     */
    getDepartmentByParentId(parentId: number): Observable<ListResultDtoOfGetDepartmentOutput> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/GetDepartmentByParentId?";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetDepartmentByParentId(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetDepartmentByParentId(response_);
                } catch (e) {
                    return <Observable<ListResultDtoOfGetDepartmentOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<ListResultDtoOfGetDepartmentOutput>><any>Observable.throw(response_);
        });
    }

    protected processGetDepartmentByParentId(response: Response): Observable<ListResultDtoOfGetDepartmentOutput> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? ListResultDtoOfGetDepartmentOutput.fromJS(resultData200) : new ListResultDtoOfGetDepartmentOutput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<ListResultDtoOfGetDepartmentOutput>(<any>null);
    }

    /**
     * @return Success
     */
    getRootDepartmentByCompanyId(companyId: number): Observable<ListResultDtoOfGetDepartmentOutput> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/GetRootDepartmentByCompanyId?";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetRootDepartmentByCompanyId(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetRootDepartmentByCompanyId(response_);
    ...
    protected processGetRootDepartmentByCompanyId(response: Response): Observable<ListResultDtoOfGetDepartmentOutput> {
        const status = response.status;
     ...
     * @return Success
     */
    getUsersByCompanyAndDepart(companyId: number, departmentId: number, sorting: string, maxResultCount: number, skipCount: number): Observable<PagedResultDtoOfUserInfo> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/GetUsersByCompanyAndDepart?";
        if (companyId !== undefined)
            url_ += "CompanyId=" + encodeURIComponent("" + companyId) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetUsersByCompanyAndDepart(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetUsersByCompanyAndDepart(response_);
    ...
    protected processGetUsersByCompanyAndDepart(response: Response): Observable<PagedResultDtoOfUserInfo> {
        const status = response.status;
     ...
     * @return Success
     */
    addUserToTenant(userId: number, userName: string): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/AddUserToTenant?";
        if (userId !== undefined)
            url_ += "userId=" + encodeURIComponent("" + userId) + "&";
        if (userName !== undefined)
            url_ += "userName=" + encodeURIComponent("" + userName) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processAddUserToTenant(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processAddUserToTenant(response_);
    ...
    protected processAddUserToTenant(response: Response): Observable<void> {
        const status = response.status;
     ...
     * @return Success
     */
    delUserToTenant(userName: string): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/DelUserToTenant?";
        if (userName !== undefined)
            url_ += "userName=" + encodeURIComponent("" + userName) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processDelUserToTenant(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processDelUserToTenant(response_);
    ...
    protected processDelUserToTenant(response: Response): Observable<void> {
        const status = response.status;
    ...
    deleteUser(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/DeleteUser?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    addOrDelUsersToTenant(userList: AddUsersToTenantInput[]): Observable<ListResultDtoOfAddUsersToTenantOutput> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/AddOrDelUsersToTenant";
        url_ = url_.replace(/[?&]$/, "");

        const content_ = JSON.stringify(userList);
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processAddOrDelUsersToTenant(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processAddOrDelUsersToTenant(response_);
                } catch (e) {
                    return <Observable<ListResultDtoOfAddUsersToTenantOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<ListResultDtoOfAddUsersToTenantOutput>><any>Observable.throw(response_);
        });
    }

    protected processAddOrDelUsersToTenant(response: Response): Observable<ListResultDtoOfAddUsersToTenantOutput> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? ListResultDtoOfAddUsersToTenantOutput.fromJS(resultData200) : new ListResultDtoOfAddUsersToTenantOutput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<ListResultDtoOfAddUsersToTenantOutput>(<any>null);
    }

    /**
     * @return Success
     */
    addEmailUserToTenant(input: AddEmailUserToTenantInput): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/AddEmailUserToTenant";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processAddEmailUserToTenant(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processAddEmailUserToTenant(response_);
    ...
    protected processAddEmailUserToTenant(response: Response): Observable<void> {
        const status = response.status;
     ...
     * @return Success
     */
    getTenantUsers(groupId: number, isDelete: number, searchValue: string, sorting: string, maxResultCount: number, skipCount: number): Observable<PagedResultDtoOfGetTenantUsersOutput> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/GetTenantUsers?";
        if (groupId !== undefined)
            url_ += "GroupId=" + encodeURIComponent("" + groupId) + "&";
        if (isDelete !== undefined)
            url_ += "IsDelete=" + encodeURIComponent("" + isDelete) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetTenantUsers(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetTenantUsers(response_);
    ...
    protected processGetTenantUsers(response: Response): Observable<PagedResultDtoOfGetTenantUsersOutput> {
        const status = response.status;
   ...
   * @return Success
   */
  getTenantUsersApp(searchValue: string, compareId: number, upOrDown: boolean, maxResultCount: number): Observable<ListResultDtoOfGetTenantUsersOutput> {
    let url_ = this.baseUrl + "/api/services/app/Hrms/GetTenantUsersApp?";
    if (searchValue !== undefined)
      url_ += "SearchValue=" + encodeURIComponent("" + searchValue) + "&";
    if (compareId !== undefined)
      url_ += "CompareId=" + encodeURIComponent("" + compareId) + "&";
    if (upOrDown !== undefined)
      url_ += "UpOrDown=" + encodeURIComponent("" + upOrDown) + "&";
    if (maxResultCount !== undefined)
      url_ += "MaxResultCount=" + encodeURIComponent("" + maxResultCount) + "&";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processGetTenantUsersApp(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processGetTenantUsersApp(response_);
        } catch (e) {
          return <Observable<ListResultDtoOfGetTenantUsersOutput>><any>Observable.throw(e);
        }
      } else
        return <Observable<ListResultDtoOfGetTenantUsersOutput>><any>Observable.throw(response_);
    });
  }

  protected processGetTenantUsersApp(response: Response): Observable<ListResultDtoOfGetTenantUsersOutput> {
    const status = response.status;
    ...
    if (status === 200) {
      ...
      let result200: any = null;
      let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
      result200 = resultData200 ? ListResultDtoOfGetTenantUsersOutput.fromJS(resultData200) : new ListResultDtoOfGetTenantUsersOutput();
      return Observable.of(result200);
    } else if (status !== 200 && status !== 204) {
      const _responseText = response.text();
      return throwException("An unexpected server error occurred.", status, _responseText, _headers);
    }
    return Observable.of<ListResultDtoOfGetTenantUsersOutput>(<any>null);
  }
     ...
     * @return Success
     */
    createCorporation(input: CreateCorporationInput): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/CreateCorporation";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processCreateCorporation(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processCreateCorporation(response_);
    ...
    protected processCreateCorporation(response: Response): Observable<void> {
        const status = response.status;
     ...
     * @return Success
     */
    getRegions(strId: string): Observable<ListResultDtoOfRegionListDto> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/GetRegions?";
        if (strId !== undefined)
            url_ += "strId=" + encodeURIComponent("" + strId) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<ListResultDtoOfRegionListDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<ListResultDtoOfRegionListDto>><any>Observable.throw(response_);
        });
    }

    protected processGetRegions(response: Response): Observable<ListResultDtoOfRegionListDto> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? ListResultDtoOfRegionListDto.fromJS(resultData200) : new ListResultDtoOfRegionListDto();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<ListResultDtoOfRegionListDto>(<any>null);
    }

    /**
     * @return Success
     */
    sendNotification(): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/SendNotification";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processSendNotification(response: Response): Observable<void> {
        const status = response.status;
     ...
     * @return Success
     */
    getGroupAndUserTotal(groupId: number, isDelete: number): Observable<ListResultDtoOfGetGroupAndUserTotalOutput> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/GetGroupAndUserTotal?";
        if (groupId !== undefined)
            url_ += "groupId=" + encodeURIComponent("" + groupId) + "&";
        if (isDelete !== undefined)
            url_ += "IsDelete=" + encodeURIComponent("" + isDelete) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetGroupAndUserTotal(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetGroupAndUserTotal(response_);
                } catch (e) {
                    return <Observable<ListResultDtoOfGetGroupAndUserTotalOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<ListResultDtoOfGetGroupAndUserTotalOutput>><any>Observable.throw(response_);
        });
    }

    protected processGetGroupAndUserTotal(response: Response): Observable<ListResultDtoOfGetGroupAndUserTotalOutput> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? ListResultDtoOfGetGroupAndUserTotalOutput.fromJS(resultData200) : new ListResultDtoOfGetGroupAndUserTotalOutput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<ListResultDtoOfGetGroupAndUserTotalOutput>(<any>null);
    }

    /**
     * @return Success
     */
    deleteUsers(userIdList: number[]): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/DeleteUsers?";
    ...
    protected processDeleteUsers(response: Response): Observable<void> {
        const status = response.status;
     ...
     * @return Success
     */
    updateUserGroupInfo(input: UpdateUserGroupInfoInput[]): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/UpdateUserGroupInfo";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processUpdateUserGroupInfo(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processUpdateUserGroupInfo(response_);
    ...
    protected processUpdateUserGroupInfo(response: Response): Observable<void> {
        const status = response.status;
    ...
    deleteUserRole(userId: number, roleId: number): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/DeleteUserRole?";
        if (userId !== undefined)
            url_ += "userId=" + encodeURIComponent("" + userId) + "&";
        if (roleId !== undefined)
    ...
    protected processDeleteUserRole(response: Response): Observable<void> {
        const status = response.status;
    ...
    addUserRole(userId: number, roleId: number): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/AddUserRole?";
        if (userId !== undefined)
            url_ += "userId=" + encodeURIComponent("" + userId) + "&";
        if (roleId !== undefined)
            url_ += "roleId=" + encodeURIComponent("" + roleId) + "&";
    ...
    protected processAddUserRole(response: Response): Observable<void> {
        const status = response.status;
     ...
     * @return Success
     */
    getAllAreas(): Observable<ListResultDtoOfHrms_Area> {
        let url_ = this.baseUrl + "/api/services/app/Hrms/GetAllAreas";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetAllAreas(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetAllAreas(response_);
                } catch (e) {
                    return <Observable<ListResultDtoOfHrms_Area>><any>Observable.throw(e);
                }
            } else
                return <Observable<ListResultDtoOfHrms_Area>><any>Observable.throw(response_);
        });
    }

    protected processGetAllAreas(response: Response): Observable<ListResultDtoOfHrms_Area> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? ListResultDtoOfHrms_Area.fromJS(resultData200) : new ListResultDtoOfHrms_Area();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<ListResultDtoOfHrms_Area>(<any>null);
    }

  /**
   * @return Success
   */
  getUserPermissionsForEdit(): Observable<GetUserPermissionsForEditOutput> {
    let url_ = this.baseUrl + "/api/services/app/Hrms/GetUserPermissionsForEdit";
    url_ = url_.replace(/[?&]$/, "");
...
export class MdServiceProxy {
     ...
     * @return Success
     */
    getAllProject(): Observable<ListResultDtoOfProjectInfoListDto> {
        let url_ = this.baseUrl + "/api/services/app/Md/GetAllProject";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<ListResultDtoOfProjectInfoListDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<ListResultDtoOfProjectInfoListDto>><any>Observable.throw(response_);
        });
    }

    protected processGetAllProject(response: Response): Observable<ListResultDtoOfProjectInfoListDto> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? ListResultDtoOfProjectInfoListDto.fromJS(resultData200) : new ListResultDtoOfProjectInfoListDto();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<ListResultDtoOfProjectInfoListDto>(<any>null);
    }
}

@Injectable()
export class MeetingAgendaServiceProxy {
    private http: Http;
    private baseUrl: string;
    protected jsonParseReviver: (key: string, value: any) => any = undefined;
     ...
     * @return Success
     */
    createMeetingAgenda(input: CreateMeetingAgendaInput): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/MeetingAgenda/CreateMeetingAgenda";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processCreateMeetingAgenda(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processCreateMeetingAgenda(response_);
    ...
    protected processCreateMeetingAgenda(response: Response): Observable<void> {
        const status = response.status;
     ...
     * @return Success
     */
    deleteMeetingAgendaById(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/MeetingAgenda/DeleteMeetingAgendaById?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processDeleteMeetingAgendaById(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processDeleteMeetingAgendaById(response_);
    ...
    protected processDeleteMeetingAgendaById(response: Response): Observable<void> {
        const status = response.status;
     ...
     * @return Success
     */
    getMeetingAgendas(sorting: string, maxResultCount: number, skipCount: number): Observable<PagedResultDtoOfMeetingAgendaListDto> {
        let url_ = this.baseUrl + "/api/services/app/MeetingAgenda/GetMeetingAgendas?";
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&";
        if (maxResultCount !== undefined)
            url_ += "MaxResultCount=" + encodeURIComponent("" + maxResultCount) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetMeetingAgendas(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetMeetingAgendas(response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfMeetingAgendaListDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<PagedResultDtoOfMeetingAgendaListDto>><any>Observable.throw(response_);
        });
    }

    protected processGetMeetingAgendas(response: Response): Observable<PagedResultDtoOfMeetingAgendaListDto> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? PagedResultDtoOfMeetingAgendaListDto.fromJS(resultData200) : new PagedResultDtoOfMeetingAgendaListDto();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<PagedResultDtoOfMeetingAgendaListDto>(<any>null);
    }
}

@Injectable()
export class ModelFileServiceProxy {
    private http: Http;
    private baseUrl: string;
    protected jsonParseReviver: (key: string, value: any) => any = undefined;
     ...
     * @return Success
     */
    queryModelSourceFile(): Observable<GetModelSourceFileOutput[]> {
        let url_ = this.baseUrl + "/api/ModelFile/QueryModelSourceFile";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processQueryModelSourceFile(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processQueryModelSourceFile(response_);
                } catch (e) {
                    return <Observable<GetModelSourceFileOutput[]>><any>Observable.throw(e);
                }
            } else
                return <Observable<GetModelSourceFileOutput[]>><any>Observable.throw(response_);
        });
    }

    protected processQueryModelSourceFile(response: Response): Observable<GetModelSourceFileOutput[]> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(GetModelSourceFileOutput.fromJS(item));
            }
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
        ...
        return Observable.of<GetModelSourceFileOutput[]>(<any>null);
    }

    /**
     * @return Success
     */
    updateModelConvertStatu(fileId: number, rev: string, result: string): Observable<void> {
        let url_ = this.baseUrl + "/api/ModelFile/UpdateModelConvertStatu?";
        if (fileId !== undefined)
            url_ += "FileId=" + encodeURIComponent("" + fileId) + "&";
        if (rev !== undefined)
            url_ += "Rev=" + encodeURIComponent("" + rev) + "&";
        if (result !== undefined)
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processUpdateModelConvertStatu(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processUpdateModelConvertStatu(response_);
    ...
    protected processUpdateModelConvertStatu(response: Response): Observable<void> {
        const status = response.status;
...
@Injectable()
export class ModelGroupServiceProxy {
    private http: Http;
    private baseUrl: string;
    protected jsonParseReviver: (key: string, value: any) => any = undefined;
     ...
     * @return Success
     */
    addModelGroup(input: AddModelGroupInput): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/ModelGroup/AddModelGroup";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processAddModelGroup(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processAddModelGroup(response_);
    ...
    protected processAddModelGroup(response: Response): Observable<void> {
        const status = response.status;
     ...
     * @return Success
     */
    getModelGroupList(searchValue: string, sorting: string, maxResultCount: number, skipCount: number): Observable<PagedResultDtoOfGetModelGroupListOutput> {
        let url_ = this.baseUrl + "/api/services/app/ModelGroup/GetModelGroupList?";
        if (searchValue !== undefined)
            url_ += "SearchValue=" + encodeURIComponent("" + searchValue) + "&";
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetModelGroupList(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetModelGroupList(response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfGetModelGroupListOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<PagedResultDtoOfGetModelGroupListOutput>><any>Observable.throw(response_);
        });
    }

    protected processGetModelGroupList(response: Response): Observable<PagedResultDtoOfGetModelGroupListOutput> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? PagedResultDtoOfGetModelGroupListOutput.fromJS(resultData200) : new PagedResultDtoOfGetModelGroupListOutput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<PagedResultDtoOfGetModelGroupListOutput>(<any>null);
    }

    /**
     * @return Success
     */
    deleteModelGroupFile(groupId: number, fileIds: number[]): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/ModelGroup/DeleteModelGroupFile?";
        if (groupId !== undefined)
            url_ += "groupId=" + encodeURIComponent("" + groupId) + "&";
        if (fileIds !== undefined)
            fileIds && fileIds.forEach(item => { url_ += "fileIds=" + encodeURIComponent("" + item) + "&"; });
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processDeleteModelGroupFile(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processDeleteModelGroupFile(response_);
    ...
    protected processDeleteModelGroupFile(response: Response): Observable<void> {
        const status = response.status;
...
export class ProfileServiceProxy {
     ...
     * @return Success
     */
    getProfilePictureT(userId: string): Observable<GetProfilePictureOutput> {
        let url_ = this.baseUrl + "/api/services/app/Profile/GetProfilePictureT?";
        if (userId !== undefined)
            url_ += "userId=" + encodeURIComponent("" + userId) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetProfilePictureT(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetProfilePictureT(response_);
    ...
    protected processGetProfilePictureT(response: Response): Observable<GetProfilePictureOutput> {
        const status = response.status;
...
export class ResourceServiceProxy {
     ...
     * @return Success
     */
    createDir(dirInput: CreateOrUpdateDirInput): Observable<DirAndFileOutput> {
        let url_ = this.baseUrl + "/api/services/app/Resource/CreateDir";
        url_ = url_.replace(/[?&]$/, "");

        const content_ = JSON.stringify(dirInput);
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<DirAndFileOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<DirAndFileOutput>><any>Observable.throw(response_);
        });
    }

    protected processCreateDir(response: Response): Observable<DirAndFileOutput> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? DirAndFileOutput.fromJS(resultData200) : new DirAndFileOutput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<DirAndFileOutput>(<any>null);
    }

    /**
     * @return Success
     */
    createFileAsync(fileInputList: CreateOrUpdateFileInput[]): Observable<ListResultDtoOfDirAndFileOutput> {
        let url_ = this.baseUrl + "/api/services/app/Resource/CreateFileAsync";
        url_ = url_.replace(/[?&]$/, "");

        const content_ = JSON.stringify(fileInputList);
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processCreateFileAsync(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processCreateFileAsync(response_);
                } catch (e) {
                    return <Observable<ListResultDtoOfDirAndFileOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<ListResultDtoOfDirAndFileOutput>><any>Observable.throw(response_);
        });
    }

    protected processCreateFileAsync(response: Response): Observable<ListResultDtoOfDirAndFileOutput> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? ListResultDtoOfDirAndFileOutput.fromJS(resultData200) : new ListResultDtoOfDirAndFileOutput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<ListResultDtoOfDirAndFileOutput>(<any>null);
    }

    /**
     * @return Success
     */
    delDirAndFile(iD: number, type: number): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Resource/DelDirAndFile?";
        if (iD !== undefined)
            url_ += "ID=" + encodeURIComponent("" + iD) + "&";
        if (type !== undefined)
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processDelDirAndFile(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processDelDirAndFile(response_);
    ...
    protected processDelDirAndFile(response: Response): Observable<boolean> {
        const status = response.status;
     ...
     * @return Success
     */
    insertDocAnt(docId: number, docType: number, content: string): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Resource/InsertDocAnt?";
        if (docId !== undefined)
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processInsertDocAnt(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processInsertDocAnt(response_);
    ...
    protected processInsertDocAnt(response: Response): Observable<boolean> {
        const status = response.status;
     ...
     * @return Success
     */
    getDocAnt(docId: number, docType: number): Observable<ListResultDtoOfGetAntOutput> {
        let url_ = this.baseUrl + "/api/services/app/Resource/GetDocAnt?";
        if (docId !== undefined)
            url_ += "docId=" + encodeURIComponent("" + docId) + "&";
        if (docType !== undefined)
            url_ += "docType=" + encodeURIComponent("" + docType) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetDocAnt(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetDocAnt(response_);
                } catch (e) {
                    return <Observable<ListResultDtoOfGetAntOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<ListResultDtoOfGetAntOutput>><any>Observable.throw(response_);
        });
    }

    protected processGetDocAnt(response: Response): Observable<ListResultDtoOfGetAntOutput> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? ListResultDtoOfGetAntOutput.fromJS(resultData200) : new ListResultDtoOfGetAntOutput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<ListResultDtoOfGetAntOutput>(<any>null);
    }

    /**
     * @return Success
     */
    getLogType(): Observable<string[]> {
        let url_ = this.baseUrl + "/api/services/app/Resource/GetLogType";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetLogType(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetLogType(response_);
    ...
    protected processGetLogType(response: Response): Observable<string[]> {
        const status = response.status;
     ...
     * @return Success
     */
    getResourceLog(startDate: string, endDate: string, resourceId: number, resourceType: number, optTypeList: string[], userId: number, searchValue: string, sorting: string, maxResultCount: number, skipCount: number): Observable<PagedResultDtoOfGetResourceLogOutput> {
        let url_ = this.baseUrl + "/api/services/app/Resource/GetResourceLog?";
        if (startDate !== undefined)
        ...
        if (optTypeList !== undefined)
            optTypeList && optTypeList.forEach(item => { url_ += "OptTypeList=" + encodeURIComponent("" + item) + "&"; });
        if (userId !== undefined)
            url_ += "UserId=" + encodeURIComponent("" + userId) + "&";
        if (searchValue !== undefined)
            url_ += "SearchValue=" + encodeURIComponent("" + searchValue) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetResourceLog(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetResourceLog(response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfGetResourceLogOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<PagedResultDtoOfGetResourceLogOutput>><any>Observable.throw(response_);
        });
    }

    protected processGetResourceLog(response: Response): Observable<PagedResultDtoOfGetResourceLogOutput> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? PagedResultDtoOfGetResourceLogOutput.fromJS(resultData200) : new PagedResultDtoOfGetResourceLogOutput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<PagedResultDtoOfGetResourceLogOutput>(<any>null);
    }

    /**
     * @return Success
     */
    getDirAndFile(dirId: number): Observable<ListResultDtoOfDirAndFileOutput> {
        let url_ = this.baseUrl + "/api/services/app/Resource/GetDirAndFile?";
        if (dirId !== undefined)
            url_ += "dirId=" + encodeURIComponent("" + dirId) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetDirAndFile(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetDirAndFile(response_);
    ...
    protected processGetDirAndFile(response: Response): Observable<ListResultDtoOfDirAndFileOutput> {
        const status = response.status;
     ...
     * @return Success
     */
    getFileByDirId(dirId: number): Observable<ListResultDtoOfDirAndFileOutput> {
        let url_ = this.baseUrl + "/api/services/app/Resource/GetFileByDirId?";
        if (dirId !== undefined)
            url_ += "dirId=" + encodeURIComponent("" + dirId) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetFileByDirId(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetFileByDirId(response_);
    ...
    protected processGetFileByDirId(response: Response): Observable<ListResultDtoOfDirAndFileOutput> {
        const status = response.status;
     ...
     * @return Success
     */
    getFileByDirIds(dirIds: number[], fileIds: number[], fileType: string): Observable<ListResultDtoOfDirAndFileOutput> {
        let url_ = this.baseUrl + "/api/services/app/Resource/GetFileByDirIds?";
        if (dirIds !== undefined)
            dirIds && dirIds.forEach(item => { url_ += "dirIds=" + encodeURIComponent("" + item) + "&"; });
        if (fileIds !== undefined)
            fileIds && fileIds.forEach(item => { url_ += "fileIds=" + encodeURIComponent("" + item) + "&"; });
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetFileByDirIds(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetFileByDirIds(response_);
    ...
    protected processGetFileByDirIds(response: Response): Observable<ListResultDtoOfDirAndFileOutput> {
        const status = response.status;
     ...
     * @return Success
     */
    getDirAndFileEx(dirId: number, searchValue: string, sorting: string, maxResultCount: number, skipCount: number): Observable<PagedResultDtoOfDirAndFileOutput> {
        let url_ = this.baseUrl + "/api/services/app/Resource/GetDirAndFileEx?";
        if (dirId !== undefined)
            url_ += "dirId=" + encodeURIComponent("" + dirId) + "&";
        if (searchValue !== undefined)
            url_ += "SearchValue=" + encodeURIComponent("" + searchValue) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetDirAndFileEx(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetDirAndFileEx(response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfDirAndFileOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<PagedResultDtoOfDirAndFileOutput>><any>Observable.throw(response_);
        });
    }

    protected processGetDirAndFileEx(response: Response): Observable<PagedResultDtoOfDirAndFileOutput> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? PagedResultDtoOfDirAndFileOutput.fromJS(resultData200) : new PagedResultDtoOfDirAndFileOutput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<PagedResultDtoOfDirAndFileOutput>(<any>null);
    }

    /**
     * @return Success
     */
    getDirAndFileExApp(dirId: number, startDate: moment.Moment, endDate: moment.Moment, dirCompareId: number, fileCompareId: number, upOrDown: boolean, maxResultCount: number, searchValue: string): Observable<ListResultDtoOfDirAndFileOutput> {
      let url_ = this.baseUrl + "/api/services/app/Resource/GetDirAndFileExApp?";
      if (dirId !== undefined)
        url_ += "DirId=" + encodeURIComponent("" + dirId) + "&";
      if (startDate !== undefined)
        url_ += "StartDate=" + encodeURIComponent(startDate ? "" + startDate.toJSON() : "null") + "&";
      if (endDate !== undefined)
        url_ += "EndDate=" + encodeURIComponent(endDate ? "" + endDate.toJSON() : "null") + "&";
      if (dirCompareId !== undefined)
        url_ += "DirCompareId=" + encodeURIComponent("" + dirCompareId) + "&";
      if (fileCompareId !== undefined)
        url_ += "FileCompareId=" + encodeURIComponent("" + fileCompareId) + "&";
      if (upOrDown !== undefined)
        url_ += "UpOrDown=" + encodeURIComponent("" + upOrDown) + "&";
      if (maxResultCount !== undefined)
        url_ += "MaxResultCount=" + encodeURIComponent("" + maxResultCount) + "&";
      ...
      return this.http.request(url_, options_).flatMap((response_) => {
        return this.processGetDirAndFileExApp(response_);
      }).catch((response_: any) => {
        if (response_ instanceof Response) {
          try {
            return this.processGetDirAndFileExApp(response_);
  ...
  protected processGetDirAndFileExApp(response: Response): Observable<ListResultDtoOfDirAndFileOutput> {
    const status = response.status;
     ...
     * @return Success
     */
    getFileById(fileId: number): Observable<DirAndFileOutput> {
        let url_ = this.baseUrl + "/api/services/app/Resource/GetFileById?";
        if (fileId !== undefined)
            url_ += "fileId=" + encodeURIComponent("" + fileId) + "&";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetFileById(response: Response): Observable<DirAndFileOutput> {
        const status = response.status;
     ...
     * @return Success
     */
    setFileStatus(fileId: number, iStatus: number, docType: number): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Resource/SetFileStatus?";
        if (fileId !== undefined)
            url_ += "fileId=" + encodeURIComponent("" + fileId) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processSetFileStatus(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processSetFileStatus(response_);
    ...
    protected processSetFileStatus(response: Response): Observable<boolean> {
        const status = response.status;
     ...
     * @return Success
     */
    setDirLock(id: number, locked: boolean): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Resource/SetDirLock?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        if (locked !== undefined)
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processSetDirLock(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processSetDirLock(response_);
    ...
    protected processSetDirLock(response: Response): Observable<void> {
        const status = response.status;
     ...
     * @return Success
     */
    setFileLock(id: number, locked: boolean): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Resource/SetFileLock?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        if (locked !== undefined)
            url_ += "locked=" + encodeURIComponent("" + locked) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processSetFileLock(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processSetFileLock(response_);
    ...
    protected processSetFileLock(response: Response): Observable<void> {
        const status = response.status;
     ...
     * @return Success
     */
    getDir(parentId: number): Observable<ListResultDtoOfGetDirOutput> {
        let url_ = this.baseUrl + "/api/services/app/Resource/GetDir?";
        if (parentId !== undefined)
            url_ += "parentId=" + encodeURIComponent("" + parentId) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetDir(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetDir(response_);
                } catch (e) {
                    return <Observable<ListResultDtoOfGetDirOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<ListResultDtoOfGetDirOutput>><any>Observable.throw(response_);
        });
    }

    protected processGetDir(response: Response): Observable<ListResultDtoOfGetDirOutput> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? ListResultDtoOfGetDirOutput.fromJS(resultData200) : new ListResultDtoOfGetDirOutput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<ListResultDtoOfGetDirOutput>(<any>null);
    }

    /**
     * @return Success
     */
    getAllDir(): Observable<ListResultDtoOfGetDirOutput> {
        let url_ = this.baseUrl + "/api/services/app/Resource/GetAllDir";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetAllDir(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetAllDir(response_);
    ...
    protected processGetAllDir(response: Response): Observable<ListResultDtoOfGetDirOutput> {
        const status = response.status;
     ...
     * @return Success
     */
    getTenantRootDir(tenantName: string): Observable<GetDirOutput> {
        let url_ = this.baseUrl + "/api/services/app/Resource/GetTenantRootDir?";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetTenantRootDir(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetTenantRootDir(response_);
                } catch (e) {
                    return <Observable<GetDirOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<GetDirOutput>><any>Observable.throw(response_);
        });
    }

    protected processGetTenantRootDir(response: Response): Observable<GetDirOutput> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? GetDirOutput.fromJS(resultData200) : new GetDirOutput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<GetDirOutput>(<any>null);
    }

    /**
     * @return Success
     */
    getFileType(fileName: string): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/Resource/GetFileType?";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetFileType(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetFileType(response_);
    ...
    protected processGetFileType(response: Response): Observable<string> {
        const status = response.status;
     ...
     * @return Success
     */
    getRvtFile(): Observable<ListResultDtoOfDirAndFileOutput> {
        let url_ = this.baseUrl + "/api/services/app/Resource/GetRvtFile";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetRvtFile(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetRvtFile(response_);
    ...
    protected processGetRvtFile(response: Response): Observable<ListResultDtoOfDirAndFileOutput> {
        const status = response.status;
     ...
     * @return Success
     */
    getFileDownloadUrl(neid: string, rev: string): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/Resource/GetFileDownloadUrl?";
        if (neid !== undefined)
            url_ += "neid=" + encodeURIComponent("" + neid) + "&";
        if (rev !== undefined)
            url_ += "rev=" + encodeURIComponent("" + rev) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetFileDownloadUrl(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetFileDownloadUrl(response_);
    ...
    protected processGetFileDownloadUrl(response: Response): Observable<string> {
        const status = response.status;
     ...
     * @return Success
     */
    getFilePreviewUrl(neid: string, rev: string): Observable<PreviewFileResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Resource/GetFilePreviewUrl?";
        if (neid !== undefined)
            url_ += "neid=" + encodeURIComponent("" + neid) + "&";
        if (rev !== undefined)
            url_ += "rev=" + encodeURIComponent("" + rev) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetFilePreviewUrl(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetFilePreviewUrl(response_);
                } catch (e) {
                    return <Observable<PreviewFileResultDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<PreviewFileResultDto>><any>Observable.throw(response_);
        });
    }

    protected processGetFilePreviewUrl(response: Response): Observable<PreviewFileResultDto> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? PreviewFileResultDto.fromJS(resultData200) : new PreviewFileResultDto();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<PreviewFileResultDto>(<any>null);
    }

    /**
     * @return Success
     */
    downloadFile(path: string, neid: string, rev: string): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Resource/DownloadFile?";
        if (path !== undefined)
    ...
    protected processDownloadFile(response: Response): Observable<boolean> {
        const status = response.status;
     ...
     * @return Success
     */
    getFileByNeidAndRev(neid: string, rev: string): Observable<DirAndFileOutput> {
        let url_ = this.baseUrl + "/api/services/app/Resource/GetFileByNeidAndRev?";
        if (neid !== undefined)
            url_ += "neid=" + encodeURIComponent("" + neid) + "&";
        if (rev !== undefined)
            url_ += "rev=" + encodeURIComponent("" + rev) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetFileByNeidAndRev(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetFileByNeidAndRev(response_);
    ...
    protected processGetFileByNeidAndRev(response: Response): Observable<DirAndFileOutput> {
        const status = response.status;
     ...
     * @return Success
     */
    editFileName(fileId: number, newName: string): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Resource/EditFileName?";
        if (fileId !== undefined)
            url_ += "fileId=" + encodeURIComponent("" + fileId) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processEditFileName(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processEditFileName(response_);
    ...
    protected processEditFileName(response: Response): Observable<boolean> {
        const status = response.status;
     ...
     * @return Success
     */
    editDirName(dirId: number, newName: string): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Resource/EditDirName?";
        if (dirId !== undefined)
            url_ += "dirId=" + encodeURIComponent("" + dirId) + "&";
        if (newName !== undefined)
            url_ += "newName=" + encodeURIComponent("" + newName) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processEditDirName(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processEditDirName(response_);
    ...
    protected processEditDirName(response: Response): Observable<boolean> {
        const status = response.status;
     ...
     * @return Success
     */
    getFilePreviewInfo(id: number): Observable<GetFilePreviewInfoOutput> {
        let url_ = this.baseUrl + "/api/services/app/Resource/GetFilePreviewInfo?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetFilePreviewInfo(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetFilePreviewInfo(response_);
                } catch (e) {
                    return <Observable<GetFilePreviewInfoOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<GetFilePreviewInfoOutput>><any>Observable.throw(response_);
        });
    }

    protected processGetFilePreviewInfo(response: Response): Observable<GetFilePreviewInfoOutput> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? GetFilePreviewInfoOutput.fromJS(resultData200) : new GetFilePreviewInfoOutput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<GetFilePreviewInfoOutput>(<any>null);
    }
}
...
export class SpecialPlanServiceProxy {
     ...
     * @return Success
     */
    getSpecialPlanData(projectName: string, groupName: string, blockName: string, planStartDate: string, planFinishDate: string, sreachValue: string, sorting: string, maxResultCount: number, skipCount: number): Observable<PagedResultDtoOfGetSpecialPlanDataOutput> {
        let url_ = this.baseUrl + "/api/services/app/SpecialPlan/GetSpecialPlanData?";
        ...
        if (planStartDate !== undefined)
            url_ += "PlanStartDate=" + encodeURIComponent("" + planStartDate) + "&";
        if (planFinishDate !== undefined)
            url_ += "PlanFinishDate=" + encodeURIComponent("" + planFinishDate) + "&";
        if (sreachValue !== undefined)
            url_ += "SreachValue=" + encodeURIComponent("" + sreachValue) + "&";
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&";
        if (maxResultCount !== undefined)
            url_ += "MaxResultCount=" + encodeURIComponent("" + maxResultCount) + "&";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetSpecialPlanData(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetSpecialPlanData(response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfGetSpecialPlanDataOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<PagedResultDtoOfGetSpecialPlanDataOutput>><any>Observable.throw(response_);
        });
    }

    protected processGetSpecialPlanData(response: Response): Observable<PagedResultDtoOfGetSpecialPlanDataOutput> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
            result200 = resultData200 ? PagedResultDtoOfGetSpecialPlanDataOutput.fromJS(resultData200) : new PagedResultDtoOfGetSpecialPlanDataOutput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<PagedResultDtoOfGetSpecialPlanDataOutput>(<any>null);
    }

    /**
     * @return Success
     */
    getPlanGroupName(projectName: string): Observable<string[]> {
        let url_ = this.baseUrl + "/api/services/app/SpecialPlan/GetPlanGroupName?";
        if (projectName !== undefined)
            url_ += "ProjectName=" + encodeURIComponent("" + projectName) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetPlanGroupName(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetPlanGroupName(response_);
    ...
    protected processGetPlanGroupName(response: Response): Observable<string[]> {
        const status = response.status;
     ...
     * @return Success
     */
    getPlanBlockName(projectName: string): Observable<string[]> {
        let url_ = this.baseUrl + "/api/services/app/SpecialPlan/GetPlanBlockName?";
        if (projectName !== undefined)
            url_ += "ProjectName=" + encodeURIComponent("" + projectName) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetPlanBlockName(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetPlanBlockName(response_);
    ...
    protected processGetPlanBlockName(response: Response): Observable<string[]> {
        const status = response.status;
...
@Injectable()
export class TaskUnitServiceProxy {
  private http: Http;
  private baseUrl: string;
  protected jsonParseReviver: (key: string, value: any) => any = undefined;
   ...
   * @return Success
   */
  createTaskUnit(input: CreateTaskUnitInput): Observable<TaskUnitListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskUnit/CreateTaskUnit";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processCreateTaskUnit(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processCreateTaskUnit(response_);
        } catch (e) {
          return <Observable<TaskUnitListDto>><any>Observable.throw(e);
        }
      } else
        return <Observable<TaskUnitListDto>><any>Observable.throw(response_);
    });
  }

  protected processCreateTaskUnit(response: Response): Observable<TaskUnitListDto> {
    const status = response.status;
    ...
    if (status === 200) {
      ...
      let result200: any = null;
      let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
      result200 = resultData200 ? TaskUnitListDto.fromJS(resultData200) : new TaskUnitListDto();
      return Observable.of(result200);
    } else if (status !== 200 && status !== 204) {
      const _responseText = response.text();
      return throwException("An unexpected server error occurred.", status, _responseText, _headers);
    }
    return Observable.of<TaskUnitListDto>(<any>null);
  }

  /**
   * @return Success
   */
  editTaskUnitImgById(taskId: string, input: CreateTaskUnitInput): Observable<ListResultDtoOfRelativeViewListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskUnit/EditTaskUnitImgById?";
    if (taskId !== undefined)
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processEditTaskUnitImgById(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processEditTaskUnitImgById(response_);
        } catch (e) {
          return <Observable<ListResultDtoOfRelativeViewListDto>><any>Observable.throw(e);
        }
      } else
        return <Observable<ListResultDtoOfRelativeViewListDto>><any>Observable.throw(response_);
    });
  }

  protected processEditTaskUnitImgById(response: Response): Observable<ListResultDtoOfRelativeViewListDto> {
    const status = response.status;
    ...
    if (status === 200) {
      ...
      let result200: any = null;
      let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
      result200 = resultData200 ? ListResultDtoOfRelativeViewListDto.fromJS(resultData200) : new ListResultDtoOfRelativeViewListDto();
      return Observable.of(result200);
    } else if (status !== 200 && status !== 204) {
      const _responseText = response.text();
      return throwException("An unexpected server error occurred.", status, _responseText, _headers);
    }
    return Observable.of<ListResultDtoOfRelativeViewListDto>(<any>null);
  }

  /**
   * @return Success
   */
  getTaskUnits(creationDateStart: moment.Moment, creationDateEnd: moment.Moment, state: number[], priority: number[], type: number[], searchValue: string, sorting: string, maxResultCount: number, skipCount: number): Observable<PagedResultDtoOfTaskUnitListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskUnit/GetTaskUnits?";
    ...
    if (priority !== undefined)
      priority && priority.forEach(item => { url_ += "Priority=" + encodeURIComponent("" + item) + "&"; });
    if (type !== undefined)
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processGetTaskUnits(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processGetTaskUnits(response_);
        } catch (e) {
          return <Observable<PagedResultDtoOfTaskUnitListDto>><any>Observable.throw(e);
        }
      } else
        return <Observable<PagedResultDtoOfTaskUnitListDto>><any>Observable.throw(response_);
    });
  }

  protected processGetTaskUnits(response: Response): Observable<PagedResultDtoOfTaskUnitListDto> {
    const status = response.status;
    ...
    if (status === 200) {
      ...
      let result200: any = null;
      let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
      result200 = resultData200 ? PagedResultDtoOfTaskUnitListDto.fromJS(resultData200) : new PagedResultDtoOfTaskUnitListDto();
      return Observable.of(result200);
    } else if (status !== 200 && status !== 204) {
      const _responseText = response.text();
      return throwException("An unexpected server error occurred.", status, _responseText, _headers);
    }
    return Observable.of<PagedResultDtoOfTaskUnitListDto>(<any>null);
  }

  /**
   * @return Success
   */
  getTaskUnitsApp(startDate: moment.Moment, endDate: moment.Moment, compareDate: moment.Moment, upOrDown: boolean, maxResultCount: number, state: number[], priority: number[], type: number[], searchValue: string): Observable<ListResultDtoOfTaskUnitListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskUnit/GetTaskUnitsApp?";
    if (startDate !== undefined)
      url_ += "StartDate=" + encodeURIComponent(startDate ? "" + startDate.toJSON() : "null") + "&";
    if (endDate !== undefined)
      url_ += "EndDate=" + encodeURIComponent(endDate ? "" + endDate.toJSON() : "null") + "&";
    if (compareDate !== undefined)
      url_ += "CompareDate=" + encodeURIComponent(compareDate ? "" + compareDate.toJSON() : "null") + "&";
    if (upOrDown !== undefined)
      url_ += "UpOrDown=" + encodeURIComponent("" + upOrDown) + "&";
    if (maxResultCount !== undefined)
      url_ += "MaxResultCount=" + encodeURIComponent("" + maxResultCount) + "&";
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processGetTaskUnitsApp(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processGetTaskUnitsApp(response_);
        } catch (e) {
          return <Observable<ListResultDtoOfTaskUnitListDto>><any>Observable.throw(e);
        }
      } else
        return <Observable<ListResultDtoOfTaskUnitListDto>><any>Observable.throw(response_);
    });
  }

  protected processGetTaskUnitsApp(response: Response): Observable<ListResultDtoOfTaskUnitListDto> {
    const status = response.status;
    ...
    if (status === 200) {
      ...
      let result200: any = null;
      let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
      result200 = resultData200 ? ListResultDtoOfTaskUnitListDto.fromJS(resultData200) : new ListResultDtoOfTaskUnitListDto();
      return Observable.of(result200);
    } else if (status !== 200 && status !== 204) {
      const _responseText = response.text();
      return throwException("An unexpected server error occurred.", status, _responseText, _headers);
    }
    return Observable.of<ListResultDtoOfTaskUnitListDto>(<any>null);
  }

  /**
   * @return Success
   */
  getTaskTags(text: string): Observable<ListResultDtoOfTaskUnitListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskUnit/GetTaskTags?";
    if (text !== undefined)
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processGetTaskTags(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processGetTaskTags(response_);
  ...
  protected processGetTaskTags(response: Response): Observable<ListResultDtoOfTaskUnitListDto> {
    const status = response.status;
  ...
  getTaskTypes(): Observable<string[]> {
    let url_ = this.baseUrl + "/api/services/app/TaskUnit/GetTaskTypes";
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processGetTaskTypes(response: Response): Observable<string[]> {
    const status = response.status;
   ...
   * @return Success
   */
  deleteTaskUnits(taskIds: string[]): Observable<ListResultDtoOfTaskUnitListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskUnit/DeleteTaskUnits?";
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processDeleteTaskUnits(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processDeleteTaskUnits(response_);
  ...
  protected processDeleteTaskUnits(response: Response): Observable<ListResultDtoOfTaskUnitListDto> {
    const status = response.status;
   ...
   * @return Success
   */
  getPicturesList(taskId: string): Observable<ListResultDtoOfRelativeViewListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskUnit/GetPicturesList?";
    if (taskId !== undefined)
      url_ += "taskId=" + encodeURIComponent("" + taskId) + "&";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processGetPicturesList(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processGetPicturesList(response_);
  ...
  protected processGetPicturesList(response: Response): Observable<ListResultDtoOfRelativeViewListDto> {
    const status = response.status;
   ...
   * @return Success
   */
  getDefaultView(taskId: string): Observable<RelativeViewListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskUnit/GetDefaultView?";
    if (taskId !== undefined)
      url_ += "taskId=" + encodeURIComponent("" + taskId) + "&";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processGetDefaultView(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processGetDefaultView(response_);
        } catch (e) {
          return <Observable<RelativeViewListDto>><any>Observable.throw(e);
        }
      } else
        return <Observable<RelativeViewListDto>><any>Observable.throw(response_);
    });
  }

  protected processGetDefaultView(response: Response): Observable<RelativeViewListDto> {
    const status = response.status;
    ...
    if (status === 200) {
      ...
      let result200: any = null;
      let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
      result200 = resultData200 ? RelativeViewListDto.fromJS(resultData200) : new RelativeViewListDto();
      return Observable.of(result200);
    } else if (status !== 200 && status !== 204) {
      const _responseText = response.text();
      return throwException("An unexpected server error occurred.", status, _responseText, _headers);
    }
    return Observable.of<RelativeViewListDto>(<any>null);
  }

  /**
   * @return Success
   */
  getTaskUnitById(taskId: string): Observable<TaskUnitListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskUnit/GetTaskUnitById?";
    if (taskId !== undefined)
      url_ += "taskId=" + encodeURIComponent("" + taskId) + "&";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processGetTaskUnitById(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processGetTaskUnitById(response_);
  ...
  protected processGetTaskUnitById(response: Response): Observable<TaskUnitListDto> {
    const status = response.status;
   ...
   * @return Success
   */
  getTaskUnitsByFileId(fileId: number): Observable<ListResultDtoOfTaskUnitListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskUnit/GetTaskUnitsByFileId?";
    if (fileId !== undefined)
      url_ += "fileId=" + encodeURIComponent("" + fileId) + "&";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processGetTaskUnitsByFileId(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processGetTaskUnitsByFileId(response_);
  ...
  protected processGetTaskUnitsByFileId(response: Response): Observable<ListResultDtoOfTaskUnitListDto> {
    const status = response.status;
   ...
   * @return Success
   */
  getTaskUnitLogs(taskId: string): Observable<ListResultDtoOfTaskUnitOrViewLogListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskUnit/GetTaskUnitLogs?";
    if (taskId !== undefined)
      url_ += "taskId=" + encodeURIComponent("" + taskId) + "&";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processGetTaskUnitLogs(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processGetTaskUnitLogs(response_);
        } catch (e) {
          return <Observable<ListResultDtoOfTaskUnitOrViewLogListDto>><any>Observable.throw(e);
        }
      } else
        return <Observable<ListResultDtoOfTaskUnitOrViewLogListDto>><any>Observable.throw(response_);
    });
  }

  protected processGetTaskUnitLogs(response: Response): Observable<ListResultDtoOfTaskUnitOrViewLogListDto> {
    const status = response.status;
    ...
    if (status === 200) {
      ...
      let result200: any = null;
      let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
      result200 = resultData200 ? ListResultDtoOfTaskUnitOrViewLogListDto.fromJS(resultData200) : new ListResultDtoOfTaskUnitOrViewLogListDto();
      return Observable.of(result200);
    } else if (status !== 200 && status !== 204) {
      const _responseText = response.text();
      return throwException("An unexpected server error occurred.", status, _responseText, _headers);
    }
    return Observable.of<ListResultDtoOfTaskUnitOrViewLogListDto>(<any>null);
  }

  /**
   * @return Success
   */
  createTaskUnitLog(input: CreateTaskOrViewLogInput): Observable<TaskUnitOrViewLogListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskUnit/CreateTaskUnitLog";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processCreateTaskUnitLog(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processCreateTaskUnitLog(response_);
        } catch (e) {
          return <Observable<TaskUnitOrViewLogListDto>><any>Observable.throw(e);
        }
      } else
        return <Observable<TaskUnitOrViewLogListDto>><any>Observable.throw(response_);
    });
  }

  protected processCreateTaskUnitLog(response: Response): Observable<TaskUnitOrViewLogListDto> {
    const status = response.status;
    ...
    if (status === 200) {
      ...
      let result200: any = null;
      let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
      result200 = resultData200 ? TaskUnitOrViewLogListDto.fromJS(resultData200) : new TaskUnitOrViewLogListDto();
      return Observable.of(result200);
    } else if (status !== 200 && status !== 204) {
      const _responseText = response.text();
      return throwException("An unexpected server error occurred.", status, _responseText, _headers);
    }
    return Observable.of<TaskUnitOrViewLogListDto>(<any>null);
  }

  /**
   * @return Success
   */
  updateTaskUnitSingle(input: EditTaskUnitInput): Observable<boolean> {
    let url_ = this.baseUrl + "/api/services/app/TaskUnit/UpdateTaskUnitSingle";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processUpdateTaskUnitSingle(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processUpdateTaskUnitSingle(response_);
  ...
  protected processUpdateTaskUnitSingle(response: Response): Observable<boolean> {
    const status = response.status;
   ...
   * @return Success
   */
  updateTaskUnit(input: EditTaskUnitInput): Observable<boolean> {
    let url_ = this.baseUrl + "/api/services/app/TaskUnit/UpdateTaskUnit";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processUpdateTaskUnit(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processUpdateTaskUnit(response_);
  ...
  protected processUpdateTaskUnit(response: Response): Observable<boolean> {
    const status = response.status;
   ...
   * @return Success
   */
  updateTaskUnitState(taskId: string, state: number): Observable<boolean> {
    let url_ = this.baseUrl + "/api/services/app/TaskUnit/UpdateTaskUnitState?";
    if (taskId !== undefined)
      url_ += "taskId=" + encodeURIComponent("" + taskId) + "&";
    if (state !== undefined)
      url_ += "state=" + encodeURIComponent("" + state) + "&";
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processUpdateTaskUnitState(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processUpdateTaskUnitState(response_);
  ...
  protected processUpdateTaskUnitState(response: Response): Observable<boolean> {
    const status = response.status;
   ...
   * @return Success
   */
  deleteTaskFiles(ids: number[]): Observable<void> {
    let url_ = this.baseUrl + "/api/services/app/TaskUnit/DeleteTaskFiles?";
    if (ids !== undefined)
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processDeleteTaskFiles(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processDeleteTaskFiles(response_);
  ...
  protected processDeleteTaskFiles(response: Response): Observable<void> {
    const status = response.status;
   ...
   * @return Success
   */
  deleteTaskUnitRelationToView(list: any[]): Observable<void> {
    let url_ = this.baseUrl + "/api/services/app/TaskUnit/DeleteTaskUnitRelationToView?";
    if (list !== undefined)
      list && list.forEach((item, index) => {
        for (let attr in item)
          url_ += "list[" + index + "]." + attr + "=" + encodeURIComponent("" + item[attr]) + "&";
      });
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processDeleteTaskUnitRelationToView(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processDeleteTaskUnitRelationToView(response_);
  ...
  protected processDeleteTaskUnitRelationToView(response: Response): Observable<void> {
    const status = response.status;
...
@Injectable()
export class TaskViewServiceProxy {
  private http: Http;
  private baseUrl: string;
  protected jsonParseReviver: (key: string, value: any) => any = undefined;
   ...
   * @return Success
   */
  createTaskView(input: CreateTaskViewInput): Observable<TaskViewListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskView/CreateTaskView";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processCreateTaskView(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processCreateTaskView(response_);
        } catch (e) {
          return <Observable<TaskViewListDto>><any>Observable.throw(e);
        }
      } else
        return <Observable<TaskViewListDto>><any>Observable.throw(response_);
    });
  }

  protected processCreateTaskView(response: Response): Observable<TaskViewListDto> {
    const status = response.status;
    ...
    if (status === 200) {
      ...
      let result200: any = null;
      let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
      result200 = resultData200 ? TaskViewListDto.fromJS(resultData200) : new TaskViewListDto();
      return Observable.of(result200);
    } else if (status !== 200 && status !== 204) {
      const _responseText = response.text();
      return throwException("An unexpected server error occurred.", status, _responseText, _headers);
    }
    return Observable.of<TaskViewListDto>(<any>null);
  }

  /**
   * @return Success
   */
  getTaskViews(creationDateStart: moment.Moment, creationDateEnd: moment.Moment, type: number[], searchValue: string, sorting: string, maxResultCount: number, skipCount: number): Observable<PagedResultDtoOfTaskViewListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskView/GetTaskViews?";
    if (creationDateStart !== undefined)
      url_ += "CreationDateStart=" + encodeURIComponent(creationDateStart ? "" + creationDateStart.toJSON() : "null") + "&";
    if (creationDateEnd !== undefined)
      url_ += "CreationDateEnd=" + encodeURIComponent(creationDateEnd ? "" + creationDateEnd.toJSON() : "null") + "&";
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processGetTaskViews(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processGetTaskViews(response_);
        } catch (e) {
          return <Observable<PagedResultDtoOfTaskViewListDto>><any>Observable.throw(e);
        }
      } else
        return <Observable<PagedResultDtoOfTaskViewListDto>><any>Observable.throw(response_);
    });
  }

  protected processGetTaskViews(response: Response): Observable<PagedResultDtoOfTaskViewListDto> {
    const status = response.status;
    ...
    if (status === 200) {
      ...
      let result200: any = null;
      let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
      result200 = resultData200 ? PagedResultDtoOfTaskViewListDto.fromJS(resultData200) : new PagedResultDtoOfTaskViewListDto();
      return Observable.of(result200);
    } else if (status !== 200 && status !== 204) {
      const _responseText = response.text();
      return throwException("An unexpected server error occurred.", status, _responseText, _headers);
    }
    return Observable.of<PagedResultDtoOfTaskViewListDto>(<any>null);
  }

  /**
   * @return Success
   */
  getTaskViewsApp(startDate: moment.Moment, endDate: moment.Moment, compareDate: moment.Moment, upOrDown: boolean, maxResultCount: number, type: number[], searchValue: string): Observable<ListResultDtoOfTaskViewListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskView/GetTaskViewsApp?";
    if (startDate !== undefined)
      url_ += "StartDate=" + encodeURIComponent(startDate ? "" + startDate.toJSON() : "null") + "&";
    if (endDate !== undefined)
      url_ += "EndDate=" + encodeURIComponent(endDate ? "" + endDate.toJSON() : "null") + "&";
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processGetTaskViewsApp(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processGetTaskViewsApp(response_);
        } catch (e) {
          return <Observable<ListResultDtoOfTaskViewListDto>><any>Observable.throw(e);
        }
      } else
        return <Observable<ListResultDtoOfTaskViewListDto>><any>Observable.throw(response_);
    });
  }

  protected processGetTaskViewsApp(response: Response): Observable<ListResultDtoOfTaskViewListDto> {
    const status = response.status;
    ...
    if (status === 200) {
      ...
      let result200: any = null;
      let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
      result200 = resultData200 ? ListResultDtoOfTaskViewListDto.fromJS(resultData200) : new ListResultDtoOfTaskViewListDto();
      return Observable.of(result200);
    } else if (status !== 200 && status !== 204) {
      const _responseText = response.text();
      return throwException("An unexpected server error occurred.", status, _responseText, _headers);
    }
    return Observable.of<ListResultDtoOfTaskViewListDto>(<any>null);
  }

  /**
   * @return Success
   */
  getShareUsers(viewId: string): Observable<ListResultDtoOfViewShareUserListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskView/GetShareUsers?";
    if (viewId !== undefined)
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processGetShareUsers(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processGetShareUsers(response_);
        } catch (e) {
          return <Observable<ListResultDtoOfViewShareUserListDto>><any>Observable.throw(e);
        }
      } else
        return <Observable<ListResultDtoOfViewShareUserListDto>><any>Observable.throw(response_);
    });
  }

  protected processGetShareUsers(response: Response): Observable<ListResultDtoOfViewShareUserListDto> {
    const status = response.status;
    ...
    if (status === 200) {
      ...
      let result200: any = null;
      let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver).result;
      result200 = resultData200 ? ListResultDtoOfViewShareUserListDto.fromJS(resultData200) : new ListResultDtoOfViewShareUserListDto();
      return Observable.of(result200);
    } else if (status !== 200 && status !== 204) {
      const _responseText = response.text();
      return throwException("An unexpected server error occurred.", status, _responseText, _headers);
    }
    return Observable.of<ListResultDtoOfViewShareUserListDto>(<any>null);
  }

  /**
   * @return Success
   */
  deleteTaskViews(viewIds: string[]): Observable<ListResultDtoOfTaskViewListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskView/DeleteTaskViews?";
    if (viewIds !== undefined)
      viewIds && viewIds.forEach(item => { url_ += "viewIds=" + encodeURIComponent("" + item) + "&"; });
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processDeleteTaskViews(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processDeleteTaskViews(response_);
  ...
  protected processDeleteTaskViews(response: Response): Observable<ListResultDtoOfTaskViewListDto> {
    const status = response.status;
   ...
   * @return Success
   */
  getTaskViewsByFileId(fileId: number): Observable<ListResultDtoOfTaskViewListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskView/GetTaskViewsByFileId?";
    if (fileId !== undefined)
      url_ += "fileId=" + encodeURIComponent("" + fileId) + "&";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processGetTaskViewsByFileId(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processGetTaskViewsByFileId(response_);
  ...
  protected processGetTaskViewsByFileId(response: Response): Observable<ListResultDtoOfTaskViewListDto> {
    const status = response.status;
   ...
   * @return Success
   */
  getTaskViewById(viewId: string): Observable<TaskViewListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskView/GetTaskViewById?";
    if (viewId !== undefined)
      url_ += "viewId=" + encodeURIComponent("" + viewId) + "&";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processGetTaskViewById(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processGetTaskViewById(response_);
  ...
  protected processGetTaskViewById(response: Response): Observable<TaskViewListDto> {
    const status = response.status;
   ...
   * @return Success
   */
  getTaskViewsByTaskId(taskId: string): Observable<ListResultDtoOfTaskViewListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskView/GetTaskViewsByTaskId?";
    if (taskId !== undefined)
      url_ += "taskId=" + encodeURIComponent("" + taskId) + "&";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processGetTaskViewsByTaskId(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processGetTaskViewsByTaskId(response_);
  ...
  protected processGetTaskViewsByTaskId(response: Response): Observable<ListResultDtoOfTaskViewListDto> {
    const status = response.status;
   ...
   * @return Success
   */
  getTaskViewLogs(viewId: string): Observable<ListResultDtoOfTaskUnitOrViewLogListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskView/GetTaskViewLogs?";
    if (viewId !== undefined)
      url_ += "viewId=" + encodeURIComponent("" + viewId) + "&";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processGetTaskViewLogs(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processGetTaskViewLogs(response_);
  ...
  protected processGetTaskViewLogs(response: Response): Observable<ListResultDtoOfTaskUnitOrViewLogListDto> {
    const status = response.status;
   ...
   * @return Success
   */
  createTaskViewLog(input: CreateTaskOrViewLogInput): Observable<TaskUnitOrViewLogListDto> {
    let url_ = this.baseUrl + "/api/services/app/TaskView/CreateTaskViewLog";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request(url_, options_).flatMap((response_) => {
      return this.processCreateTaskViewLog(response_);
    }).catch((response_: any) => {
      if (response_ instanceof Response) {
        try {
          return this.processCreateTaskViewLog(response_);
  ...
  protected processCreateTaskViewLog(response: Response): Observable<TaskUnitOrViewLogListDto> {
    const status = response.status;
...
export class TenantServiceProxy {
     ...
     * @return Success
     */
    getTenants(filter: string, subscriptionEndDateStart: moment.Moment, subscriptionEndDateEnd: moment.Moment, creationDateStart: moment.Moment, creationDateEnd: moment.Moment, editionId: number, editionIdSpecified: boolean, corporation: number[], sorting: string, maxResultCount: number, skipCount: number): Observable<PagedResultDtoOfTenantListDto> {
        ...
        if (corporation !== undefined)
            corporation && corporation.forEach(item => { url_ += "Corporation=" + encodeURIComponent("" + item) + "&"; });
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&";
        if (maxResultCount !== undefined)
            url_ += "MaxResultCount=" + encodeURIComponent("" + maxResultCount) + "&";
     ...
     * @return Success
     */
    getAllTenants(filter: string, subscriptionEndDateStart: moment.Moment, subscriptionEndDateEnd: moment.Moment, creationDateStart: moment.Moment, creationDateEnd: moment.Moment, editionId: number, editionIdSpecified: boolean, corporation: number[], sorting: string, maxResultCount: number, skipCount: number): Observable<ListResultDtoOfTenantListDto> {
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                ...
                return <Observable<ListResultDtoOfTenantListDto>><any>Observable.throw(response_);
        });
    }

    protected processGetAllTenants(response: Response): Observable<ListResultDtoOfTenantListDto> {
        const status = response.status;
        ...
        return Observable.of<ListResultDtoOfTenantListDto>(<any>null);
    }

    /**
     * @return Success
     */
    createTenant(input: CreateTenantInput): Observable<number> {
    ...
    protected processCreateTenant(response: Response): Observable<number> {
        const status = response.status;
     ...
     * @return Success
     */
    updateTenant2(): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Tenant/UpdateTenant2";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processUpdateTenant2(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processUpdateTenant2(response_);
    ...
    protected processUpdateTenant2(response: Response): Observable<void> {
        const status = response.status;
...
export class TokenAuthServiceProxy {
     ...
     * @return Success
     */
    authenticateEx(model: AuthenticateModel, tenintId: number): Observable<AuthenticateResultModel> {
        let url_ = this.baseUrl + "/api/TokenAuth/AuthenticateEx?";
        if (tenintId !== undefined)
            url_ += "tenintId=" + encodeURIComponent("" + tenintId) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processAuthenticateEx(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processAuthenticateEx(response_);
    ...
    protected processAuthenticateEx(response: Response): Observable<AuthenticateResultModel> {
        const status = response.status;
...
export class UserServiceProxy {
     ...
     * @return Success
     */
    getUserNames(text: string): Observable<ListResultDtoOfUserListDto> {
        let url_ = this.baseUrl + "/api/services/app/User/GetUserNames?";
        if (text !== undefined)
            url_ += "text=" + encodeURIComponent("" + text) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                ...
                return <Observable<ListResultDtoOfUserListDto>><any>Observable.throw(response_);
        });
    }

    protected processGetUserNames(response: Response): Observable<ListResultDtoOfUserListDto> {
        const status = response.status;
        ...
        return Observable.of<ListResultDtoOfUserListDto>(<any>null);
    }
}
...
export class ListResultDtoOfGetGroupsOutput implements IListResultDtoOfGetGroupsOutput {
    items: GetGroupsOutput[];

    constructor(data?: IListResultDtoOfGetGroupsOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(GetGroupsOutput.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfGetGroupsOutput {
        let result = new ListResultDtoOfGetGroupsOutput();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfGetGroupsOutput {
    items: GetGroupsOutput[];
}

export class GetGroupsOutput implements IGetGroupsOutput {
    groupName: string;
    userCounts: number;
    groupIcon: string;
    isDeleted: boolean;
    ...
    constructor(data?: IGetGroupsOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetGroupsOutput {
        let result = new GetGroupsOutput();
        result.init(data);
        return result;
    }
...
export interface IGetGroupsOutput {
    groupName: string;
    userCounts: number;
    groupIcon: string;
    isDeleted: boolean;
...
export class PagedResultDtoOfGetTenantUsersOutput implements IPagedResultDtoOfGetTenantUsersOutput {
    totalCount: number;
    items: GetTenantUsersOutput[];

    constructor(data?: IPagedResultDtoOfGetTenantUsersOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(GetTenantUsersOutput.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfGetTenantUsersOutput {
        let result = new PagedResultDtoOfGetTenantUsersOutput();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfGetTenantUsersOutput {
    totalCount: number;
    items: GetTenantUsersOutput[];
}

export class GetTenantUsersOutput implements IGetTenantUsersOutput {
    name: string;
    surname: string;
    userName: string;
    emailAddress: string;
    ...
    jobTitle: string;
    isDeleted: boolean;
    roles: GetTenantUsersRolesOutput[];
    id: number;

    constructor(data?: IGetTenantUsersOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (data) {
            ...
            if (data["roles"] && data["roles"].constructor === Array) {
                ...
                for (let item of data["roles"])
                    this.roles.push(GetTenantUsersRolesOutput.fromJS(item));
            }
            this.id = data["id"];
        }
    }

    static fromJS(data: any): GetTenantUsersOutput {
        let result = new GetTenantUsersOutput();
        result.init(data);
        return result;
    }
...
export interface IGetTenantUsersOutput {
    name: string;
    surname: string;
    userName: string;
    emailAddress: string;
...
export class GetTenantUsersRolesOutput implements IGetTenantUsersRolesOutput {
    displayName: string;
    name: string;
    id: number;

    constructor(data?: IGetTenantUsersRolesOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetTenantUsersRolesOutput {
        let result = new GetTenantUsersRolesOutput();
        result.init(data);
        return result;
    }
...
export interface IGetTenantUsersRolesOutput {
    displayName: string;
    name: string;
    id: number;
}

export class ListResultDtoOfGetCompanyOutput implements IListResultDtoOfGetCompanyOutput {
    items: GetCompanyOutput[];

    constructor(data?: IListResultDtoOfGetCompanyOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(GetCompanyOutput.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfGetCompanyOutput {
        let result = new ListResultDtoOfGetCompanyOutput();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfGetCompanyOutput {
    items: GetCompanyOutput[];
}
...
export class ListResultDtoOfGetDepartmentOutput implements IListResultDtoOfGetDepartmentOutput {
    items: GetDepartmentOutput[];

    constructor(data?: IListResultDtoOfGetDepartmentOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(GetDepartmentOutput.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfGetDepartmentOutput {
        let result = new ListResultDtoOfGetDepartmentOutput();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfGetDepartmentOutput {
    items: GetDepartmentOutput[];
}
...
export class PagedResultDtoOfUserInfo implements IPagedResultDtoOfUserInfo {
    totalCount: number;
    items: UserInfo[];

    constructor(data?: IPagedResultDtoOfUserInfo) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
...
export class AddUsersToTenantInput implements IAddUsersToTenantInput {
    userId: number;
    userName: string;
    addOrDel: boolean;

    constructor(data?: IAddUsersToTenantInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.userId = data["userId"];
            this.userName = data["userName"];
            this.addOrDel = data["addOrDel"];
        }
    }

    static fromJS(data: any): AddUsersToTenantInput {
        let result = new AddUsersToTenantInput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["userId"] = this.userId;
        data["userName"] = this.userName;
        data["addOrDel"] = this.addOrDel;
        return data;
    }
}

export interface IAddUsersToTenantInput {
    userId: number;
    userName: string;
    addOrDel: boolean;
}

export class ListResultDtoOfAddUsersToTenantOutput implements IListResultDtoOfAddUsersToTenantOutput {
    items: AddUsersToTenantOutput[];

    constructor(data?: IListResultDtoOfAddUsersToTenantOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(AddUsersToTenantOutput.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfAddUsersToTenantOutput {
        let result = new ListResultDtoOfAddUsersToTenantOutput();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfAddUsersToTenantOutput {
    items: AddUsersToTenantOutput[];
}

export class AddUsersToTenantOutput implements IAddUsersToTenantOutput {
    result: string;
    userId: number;
    userName: string;
    addOrDel: boolean;

    constructor(data?: IAddUsersToTenantOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): AddUsersToTenantOutput {
        let result = new AddUsersToTenantOutput();
        result.init(data);
        return result;
    }
...
export interface IAddUsersToTenantOutput {
    result: string;
    userId: number;
    userName: string;
    addOrDel: boolean;
...
export class AddEmailUserToTenantInput implements IAddEmailUserToTenantInput {
    emailAddress: string;
    name: string;
    phoneNumber: string;
    professional: string;
    ...
    constructor(data?: IAddEmailUserToTenantInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): AddEmailUserToTenantInput {
        let result = new AddEmailUserToTenantInput();
        result.init(data);
        return result;
    }
...
export interface IAddEmailUserToTenantInput {
    emailAddress: string;
    name: string;
    phoneNumber: string;
    professional: string;
...
export class ListResultDtoOfGetTenantUsersOutput implements IListResultDtoOfGetTenantUsersOutput {
  items: GetTenantUsersOutput[];

  constructor(data?: IListResultDtoOfGetTenantUsersOutput) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property))
          (<any>this)[property] = (<any>data)[property];
  ...
  static fromJS(data: any): ListResultDtoOfGetTenantUsersOutput {
    let result = new ListResultDtoOfGetTenantUsersOutput();
    result.init(data);
    return result;
  }
...
export interface IListResultDtoOfGetTenantUsersOutput {
  items: GetTenantUsersOutput[];
}
export class CreateCorporationInput implements ICreateCorporationInput {
    name: string;
    parentId: number;

    constructor(data?: ICreateCorporationInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateCorporationInput {
        let result = new CreateCorporationInput();
        result.init(data);
        return result;
    }
...
export interface ICreateCorporationInput {
    name: string;
    parentId: number;
}

export class ListResultDtoOfRegionListDto implements IListResultDtoOfRegionListDto {
    items: RegionListDto[];

    constructor(data?: IListResultDtoOfRegionListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(RegionListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfRegionListDto {
        let result = new ListResultDtoOfRegionListDto();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfRegionListDto {
    items: RegionListDto[];
}
...
export class ListResultDtoOfGetGroupAndUserTotalOutput implements IListResultDtoOfGetGroupAndUserTotalOutput {
    items: GetGroupAndUserTotalOutput[];

    constructor(data?: IListResultDtoOfGetGroupAndUserTotalOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(GetGroupAndUserTotalOutput.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfGetGroupAndUserTotalOutput {
        let result = new ListResultDtoOfGetGroupAndUserTotalOutput();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfGetGroupAndUserTotalOutput {
    items: GetGroupAndUserTotalOutput[];
}

export class GetGroupAndUserTotalOutput implements IGetGroupAndUserTotalOutput {
    groupName: string;
    groupIcon: string;
    userTotal: number;
    isDeleted: boolean;
    ...
    constructor(data?: IGetGroupAndUserTotalOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetGroupAndUserTotalOutput {
        let result = new GetGroupAndUserTotalOutput();
        result.init(data);
        return result;
    }
...
export interface IGetGroupAndUserTotalOutput {
    groupName: string;
    groupIcon: string;
    userTotal: number;
    isDeleted: boolean;
...
export class UpdateUserGroupInfoInput implements IUpdateUserGroupInfoInput {
    id: number;
    groupId: number;

    constructor(data?: IUpdateUserGroupInfoInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateUserGroupInfoInput {
        let result = new UpdateUserGroupInfoInput();
        result.init(data);
        return result;
    }
...
export interface IUpdateUserGroupInfoInput {
    id: number;
    groupId: number;
}

export class ListResultDtoOfHrms_Area implements IListResultDtoOfHrms_Area {
    items: Hrms_Area[];

    constructor(data?: IListResultDtoOfHrms_Area) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(Hrms_Area.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfHrms_Area {
        let result = new ListResultDtoOfHrms_Area();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfHrms_Area {
    items: Hrms_Area[];
}

export class Hrms_Area implements IHrms_Area {
    parentId: string;
    areaName: string;
    id: number;

    constructor(data?: IHrms_Area) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): Hrms_Area {
        let result = new Hrms_Area();
        result.init(data);
        return result;
    }
...
export class ListResultDtoOfProjectInfoListDto implements IListResultDtoOfProjectInfoListDto {
    items: ProjectInfoListDto[];

    constructor(data?: IListResultDtoOfProjectInfoListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(ProjectInfoListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfProjectInfoListDto {
        let result = new ListResultDtoOfProjectInfoListDto();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfProjectInfoListDto {
    items: ProjectInfoListDto[];
}

export class ProjectInfoListDto implements IProjectInfoListDto {
    pk_Project: string;
    project_Name: string;
    belong_Company: string;
    oa_Company_Id: number;
    belong_Area: string;
    belong_Provinces: string;
    provinceName: string;
    belong_City: string;
    cityName: string;
    ...
    constructor(data?: IProjectInfoListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.pk_Project = data["pk_Project"];
            this.project_Name = data["project_Name"];
            this.belong_Company = data["belong_Company"];
            this.oa_Company_Id = data["oa_Company_Id"];
            this.belong_Area = data["belong_Area"];
            this.belong_Provinces = data["belong_Provinces"];
            this.provinceName = data["provinceName"];
            this.belong_City = data["belong_City"];
    ...
    static fromJS(data: any): ProjectInfoListDto {
        let result = new ProjectInfoListDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["pk_Project"] = this.pk_Project;
        data["project_Name"] = this.project_Name;
        data["belong_Company"] = this.belong_Company;
        data["oa_Company_Id"] = this.oa_Company_Id;
        data["belong_Area"] = this.belong_Area;
        data["belong_Provinces"] = this.belong_Provinces;
        data["provinceName"] = this.provinceName;
        data["belong_City"] = this.belong_City;
        data["cityName"] = this.cityName;
        data["project_Address"] = this.project_Address;
        data["project_Intro"] = this.project_Intro;
        data["total_Area"] = this.total_Area;
        return data;
    }
}

export interface IProjectInfoListDto {
    pk_Project: string;
    project_Name: string;
    belong_Company: string;
    oa_Company_Id: number;
...
export class CreateMeetingAgendaInput implements ICreateMeetingAgendaInput {
    title: string;
    description: string;
    ...
    constructor(data?: ICreateMeetingAgendaInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["taskIds"] && data["taskIds"].constructor === Array) {
                this.taskIds = [];
                for (let item of data["taskIds"])
    ...
    static fromJS(data: any): CreateMeetingAgendaInput {
        let result = new CreateMeetingAgendaInput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        if (this.taskIds && this.taskIds.constructor === Array) {
            data["taskIds"] = [];
...
export interface ICreateMeetingAgendaInput {
    title: string;
    description: string;
    startTime: moment.Moment;
    endTime: moment.Moment;
...
export class PagedResultDtoOfMeetingAgendaListDto implements IPagedResultDtoOfMeetingAgendaListDto {
    totalCount: number;
    items: MeetingAgendaListDto[];

    constructor(data?: IPagedResultDtoOfMeetingAgendaListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(MeetingAgendaListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfMeetingAgendaListDto {
        let result = new PagedResultDtoOfMeetingAgendaListDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfMeetingAgendaListDto {
    totalCount: number;
    items: MeetingAgendaListDto[];
}

export class MeetingAgendaListDto implements IMeetingAgendaListDto {
    id: number;
    title: string;
    description: string;
    startTime: moment.Moment;
    ...
    creationTime: moment.Moment;
    users: MeetingParticipantListDto[];
    tasks: MeetingRelatesTaskListDto[];

    constructor(data?: IMeetingAgendaListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (data) {
            ...
            if (data["users"] && data["users"].constructor === Array) {
                ...
                for (let item of data["users"])
                    this.users.push(MeetingParticipantListDto.fromJS(item));
            }
            if (data["tasks"] && data["tasks"].constructor === Array) {
                this.tasks = [];
                for (let item of data["tasks"])
                    this.tasks.push(MeetingRelatesTaskListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): MeetingAgendaListDto {
        let result = new MeetingAgendaListDto();
        result.init(data);
        return result;
    }
...
export interface IMeetingAgendaListDto {
    id: number;
    title: string;
    description: string;
    startTime: moment.Moment;
...
export class MeetingParticipantListDto implements IMeetingParticipantListDto {
    userId: number;
    userName: string;
    id: number;

    constructor(data?: IMeetingParticipantListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): MeetingParticipantListDto {
        let result = new MeetingParticipantListDto();
        result.init(data);
        return result;
    }
...
export interface IMeetingParticipantListDto {
    userId: number;
    userName: string;
    id: number;
}

export class MeetingRelatesTaskListDto implements IMeetingRelatesTaskListDto {
    taskId: string;
    title: string;
    id: number;

    constructor(data?: IMeetingRelatesTaskListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): MeetingRelatesTaskListDto {
        let result = new MeetingRelatesTaskListDto();
        result.init(data);
        return result;
    }
...
export interface IMeetingRelatesTaskListDto {
    taskId: string;
    title: string;
    id: number;
}

export class GetModelSourceFileOutput implements IGetModelSourceFileOutput {
    id: number;
    rev: string;
    sourcePath: string;
    convertPathClient: string;
    convertPathServer: string;

    constructor(data?: IGetModelSourceFileOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.convertPathClient = data["convertPathClient"];
            this.convertPathServer = data["convertPathServer"];
        }
    }

    static fromJS(data: any): GetModelSourceFileOutput {
        let result = new GetModelSourceFileOutput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["convertPathClient"] = this.convertPathClient;
        data["convertPathServer"] = this.convertPathServer;
        return data;
    }
}

export interface IGetModelSourceFileOutput {
    id: number;
    rev: string;
    sourcePath: string;
    convertPathClient: string;
...
export class AddModelGroupInput implements IAddModelGroupInput {
    name: string;
    fileIdList: number[];
    id: number;

    constructor(data?: IAddModelGroupInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.name = data["name"];
            if (data["fileIdList"] && data["fileIdList"].constructor === Array) {
                this.fileIdList = [];
    ...
    static fromJS(data: any): AddModelGroupInput {
        let result = new AddModelGroupInput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["name"] = this.name;
        if (this.fileIdList && this.fileIdList.constructor === Array) {
            data["fileIdList"] = [];
...
export interface IAddModelGroupInput {
    name: string;
    fileIdList: number[];
    id: number;
}

export class PagedResultDtoOfGetModelGroupListOutput implements IPagedResultDtoOfGetModelGroupListOutput {
    totalCount: number;
    items: GetModelGroupListOutput[];

    constructor(data?: IPagedResultDtoOfGetModelGroupListOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(GetModelGroupListOutput.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfGetModelGroupListOutput {
        let result = new PagedResultDtoOfGetModelGroupListOutput();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfGetModelGroupListOutput {
    totalCount: number;
    items: GetModelGroupListOutput[];
}

export class GetModelGroupListOutput implements IGetModelGroupListOutput {
    name: string;
    fileList: DirAndFileOutput[];
    userName: string;
    isDeleted: boolean;
    deleterUserId: number;
    deletionTime: moment.Moment;
    ...
    constructor(data?: IGetModelGroupListOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.name = data["name"];
            if (data["fileList"] && data["fileList"].constructor === Array) {
                this.fileList = [];
                for (let item of data["fileList"])
                    this.fileList.push(DirAndFileOutput.fromJS(item));
            }
            this.userName = data["userName"];
            this.isDeleted = data["isDeleted"];
            this.deleterUserId = data["deleterUserId"];
    ...
    static fromJS(data: any): GetModelGroupListOutput {
        let result = new GetModelGroupListOutput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["name"] = this.name;
        if (this.fileList && this.fileList.constructor === Array) {
            data["fileList"] = [];
            for (let item of this.fileList)
                data["fileList"].push(item.toJSON());
        }
        data["userName"] = this.userName;
        data["isDeleted"] = this.isDeleted;
        data["deleterUserId"] = this.deleterUserId;
...
export interface IGetModelGroupListOutput {
    name: string;
    fileList: DirAndFileOutput[];
    userName: string;
    isDeleted: boolean;
...
export class DirAndFileOutput implements IDirAndFileOutput {
    dirId: number;
    name: string;
    neid: string;
    path: string;
    ...
    constructor(data?: IDirAndFileOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.path = data["path"];
            this.rev = data["rev"];
            this.checkStatu = data["checkStatu"];
            this.checkOutUser = data["checkOutUser"];
            this.size = data["size"];
            this.fileType = data["fileType"];
            this.icon = data["icon"];
            this.userName = data["userName"];
            this.lockUserName = data["lockUserName"];
            this.dataType = data["dataType"];
            this.convertStatu = data["convertStatu"];
            this.isDeleted = data["isDeleted"];
            this.deleterUserId = data["deleterUserId"];
            this.deletionTime = data["deletionTime"] ? moment(data["deletionTime"].toString()) : <any>undefined;
            this.lastModificationTime = data["lastModificationTime"] ? moment(data["lastModificationTime"].toString()) : <any>undefined;
    ...
    static fromJS(data: any): DirAndFileOutput {
        let result = new DirAndFileOutput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["path"] = this.path;
        data["rev"] = this.rev;
        data["checkStatu"] = this.checkStatu;
        data["checkOutUser"] = this.checkOutUser;
        data["size"] = this.size;
        data["fileType"] = this.fileType;
        data["icon"] = this.icon;
        data["userName"] = this.userName;
        data["lockUserName"] = this.lockUserName;
        data["dataType"] = this.dataType;
        data["convertStatu"] = this.convertStatu;
        data["isDeleted"] = this.isDeleted;
        data["deleterUserId"] = this.deleterUserId;
        data["deletionTime"] = this.deletionTime ? this.deletionTime.toISOString() : <any>undefined;
        data["lastModificationTime"] = this.lastModificationTime ? this.lastModificationTime.toISOString() : <any>undefined;
...
export interface IDirAndFileOutput {
    dirId: number;
    name: string;
    neid: string;
    path: string;
...
export class CreateOrUpdateDirInput implements ICreateOrUpdateDirInput {
    parentId: number;
    name: string;
    icon: string;
    checkStatu: number;
    ...
    constructor(data?: ICreateOrUpdateDirInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateOrUpdateDirInput {
        let result = new CreateOrUpdateDirInput();
        result.init(data);
        return result;
    }
...
export interface ICreateOrUpdateDirInput {
    parentId: number;
    name: string;
    icon: string;
    checkStatu: number;
...
export class CreateOrUpdateFileInput implements ICreateOrUpdateFileInput {
    dirId: number;
    name: string;
    neid: string;
    path: string;
    ...
    checkStatu: number;
    checkOutUser: number;
    hasCreateDir: boolean;
    id: number;

    constructor(data?: ICreateOrUpdateFileInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.checkStatu = data["checkStatu"];
            this.checkOutUser = data["checkOutUser"];
            this.hasCreateDir = data["hasCreateDir"];
            this.id = data["id"];
        }
    }

    static fromJS(data: any): CreateOrUpdateFileInput {
        let result = new CreateOrUpdateFileInput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["checkStatu"] = this.checkStatu;
        data["checkOutUser"] = this.checkOutUser;
        data["hasCreateDir"] = this.hasCreateDir;
        data["id"] = this.id;
        return data;
    }
}

export interface ICreateOrUpdateFileInput {
    dirId: number;
    name: string;
    neid: string;
    path: string;
...
export class ListResultDtoOfDirAndFileOutput implements IListResultDtoOfDirAndFileOutput {
    items: DirAndFileOutput[];

    constructor(data?: IListResultDtoOfDirAndFileOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(DirAndFileOutput.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfDirAndFileOutput {
        let result = new ListResultDtoOfDirAndFileOutput();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfDirAndFileOutput {
    items: DirAndFileOutput[];
}

export class ListResultDtoOfGetAntOutput implements IListResultDtoOfGetAntOutput {
    items: GetAntOutput[];

    constructor(data?: IListResultDtoOfGetAntOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(GetAntOutput.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfGetAntOutput {
        let result = new ListResultDtoOfGetAntOutput();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfGetAntOutput {
    items: GetAntOutput[];
}

export class GetAntOutput implements IGetAntOutput {
    docId: number;
    docType: number;
    content: string;
    userName: string;
    ...
    constructor(data?: IGetAntOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetAntOutput {
        let result = new GetAntOutput();
        result.init(data);
        return result;
    }
...
export interface IGetAntOutput {
    docId: number;
    docType: number;
    content: string;
    userName: string;
...
export class PagedResultDtoOfGetResourceLogOutput implements IPagedResultDtoOfGetResourceLogOutput {
    totalCount: number;
    items: GetResourceLogOutput[];

    constructor(data?: IPagedResultDtoOfGetResourceLogOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(GetResourceLogOutput.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfGetResourceLogOutput {
        let result = new PagedResultDtoOfGetResourceLogOutput();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfGetResourceLogOutput {
    totalCount: number;
    items: GetResourceLogOutput[];
}

export class GetResourceLogOutput implements IGetResourceLogOutput {
    resourceId: number;
    resourceType: number;
    fileName: string;
    fileType: string;
    ...
    constructor(data?: IGetResourceLogOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetResourceLogOutput {
        let result = new GetResourceLogOutput();
        result.init(data);
        return result;
    }
...
export interface IGetResourceLogOutput {
    resourceId: number;
    resourceType: number;
    fileName: string;
    fileType: string;
...
export class PagedResultDtoOfDirAndFileOutput implements IPagedResultDtoOfDirAndFileOutput {
    totalCount: number;
    items: DirAndFileOutput[];

    constructor(data?: IPagedResultDtoOfDirAndFileOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PagedResultDtoOfDirAndFileOutput {
        let result = new PagedResultDtoOfDirAndFileOutput();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfDirAndFileOutput {
    totalCount: number;
    items: DirAndFileOutput[];
}

export class ListResultDtoOfGetDirOutput implements IListResultDtoOfGetDirOutput {
    items: GetDirOutput[];

    constructor(data?: IListResultDtoOfGetDirOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(GetDirOutput.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfGetDirOutput {
        let result = new ListResultDtoOfGetDirOutput();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfGetDirOutput {
    items: GetDirOutput[];
}

export class GetDirOutput implements IGetDirOutput {
    id: number;
    parentId: number;
    name: string;

    constructor(data?: IGetDirOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetDirOutput {
        let result = new GetDirOutput();
        result.init(data);
        return result;
    }
...
export interface IGetDirOutput {
    id: number;
    parentId: number;
    name: string;
}

export class PreviewFileResultDto implements IPreviewFileResultDto {
    preview_url: string;

    constructor(data?: IPreviewFileResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PreviewFileResultDto {
        let result = new PreviewFileResultDto();
        result.init(data);
        return result;
    }
...
export interface IPreviewFileResultDto {
    preview_url: string;
}

export class GetFilePreviewInfoOutput implements IGetFilePreviewInfoOutput {
    dirId: number;
    name: string;
    neid: string;
    path: string;
    ...
    constructor(data?: IGetFilePreviewInfoOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.lockUserName = data["lockUserName"];
            this.convertStatu = data["convertStatu"];
            this.clientPath = data["clientPath"];
            this.serverPath = data["serverPath"];
          if (data["pathList"] && data["pathList"].constructor === Array) {
            this.pathList = [];
    ...
    static fromJS(data: any): GetFilePreviewInfoOutput {
        let result = new GetFilePreviewInfoOutput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["lockUserName"] = this.lockUserName;
        data["convertStatu"] = this.convertStatu;
        data["clientPath"] = this.clientPath;
        data["serverPath"] = this.serverPath;
        if (this.pathList && this.pathList.constructor === Array) {
          data["pathList"] = [];
          for (let item of this.pathList)
            data["pathList"].push(item);
        }
        data["isDeleted"] = this.isDeleted;
        data["deleterUserId"] = this.deleterUserId;
        data["deletionTime"] = this.deletionTime ? this.deletionTime.toISOString() : <any>undefined;
...
export interface IGetFilePreviewInfoOutput {
    dirId: number;
    name: string;
    neid: string;
    path: string;
...
export class GetCurrentLoginInformationsOutput implements IGetCurrentLoginInformationsOutput {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.lenovoInfo = data["lenovoInfo"] ? LenovoInfoDto.fromJS(data["lenovoInfo"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["lenovoInfo"] = this.lenovoInfo ? this.lenovoInfo.toJSON() : <any>undefined;
        return data;
    }
}
...
export class LenovoInfoDto implements ILenovoInfoDto {
    baseUrl: string;
    loginUrl: string;
    uploadUrl: string;
    downloadUrl: string;
    previewUrl: string;
    tokenInfo: LoginLenovoResultDto;

    constructor(data?: ILenovoInfoDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.tokenInfo = data["tokenInfo"] ? LoginLenovoResultDto.fromJS(data["tokenInfo"]) : <any>undefined;
        }
    }

    static fromJS(data: any): LenovoInfoDto {
        let result = new LenovoInfoDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["tokenInfo"] = this.tokenInfo ? this.tokenInfo.toJSON() : <any>undefined;
        return data;
    }
}

export interface ILenovoInfoDto {
    baseUrl: string;
    loginUrl: string;
    uploadUrl: string;
    downloadUrl: string;
...
export class LoginLenovoResultDto implements ILoginLenovoResultDto {
    uId: string;
    user_Name: string;
    account_Id: string;
    ...
    constructor(data?: ILoginLenovoResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.xLENOVOSESSID = data["X-LENOVO-SESS-ID"];
            this.s = data["S"];
        }
    }

    static fromJS(data: any): LoginLenovoResultDto {
        let result = new LoginLenovoResultDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["X-LENOVO-SESS-ID"] = this.xLENOVOSESSID;
        data["S"] = this.s;
        return data;
    }
}

export interface ILoginLenovoResultDto {
    uId: string;
    user_Name: string;
    account_Id: string;
    xLENOVOSESSID: string;
...
export class PagedResultDtoOfGetSpecialPlanDataOutput implements IPagedResultDtoOfGetSpecialPlanDataOutput {
    totalCount: number;
    items: GetSpecialPlanDataOutput[];

    constructor(data?: IPagedResultDtoOfGetSpecialPlanDataOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(GetSpecialPlanDataOutput.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfGetSpecialPlanDataOutput {
        let result = new PagedResultDtoOfGetSpecialPlanDataOutput();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfGetSpecialPlanDataOutput {
    totalCount: number;
    items: GetSpecialPlanDataOutput[];
}

export class GetSpecialPlanDataOutput implements IGetSpecialPlanDataOutput {
    planItemID: string;
    blockName: string;
    groupName: string;
    planName: string;
    taskName: string;
    taskLevel: number;
    planStartDate: moment.Moment;
    period: number;
    planFinishDate: moment.Moment;
    ...
    constructor(data?: IGetSpecialPlanDataOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.planStartDate = data["planStartDate"] ? moment(data["planStartDate"].toString()) : <any>undefined;
            this.period = data["period"];
            this.planFinishDate = data["planFinishDate"] ? moment(data["planFinishDate"].toString()) : <any>undefined;
            ...
            this.sendDeptName = data["sendDeptName"];
            this.sendPersonName = data["sendPersonName"];
            this.light = data["light"];
            this.delayDays = data["delayDays"];
        }
    }

    static fromJS(data: any): GetSpecialPlanDataOutput {
        let result = new GetSpecialPlanDataOutput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["planItemID"] = this.planItemID;
        data["blockName"] = this.blockName;
        data["groupName"] = this.groupName;
        data["planName"] = this.planName;
        data["taskName"] = this.taskName;
        data["taskLevel"] = this.taskLevel;
        data["planStartDate"] = this.planStartDate ? this.planStartDate.toISOString() : <any>undefined;
        data["period"] = this.period;
        data["planFinishDate"] = this.planFinishDate ? this.planFinishDate.toISOString() : <any>undefined;
        ...
        data["sendDeptName"] = this.sendDeptName;
        data["sendPersonName"] = this.sendPersonName;
...
export interface IGetSpecialPlanDataOutput {
    planItemID: string;
    blockName: string;
    groupName: string;
    planName: string;
...
export class CreateTaskUnitInput implements ICreateTaskUnitInput {
    title: string;
    description: string;
    priority: number;
    expirationTime: moment.Moment;
    questionClassfy: string;
    dutyer: number;
    tag: string;
    source: string;
    viewList: string[];
    ...
    constructor(data?: ICreateTaskUnitInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.expirationTime = data["expirationTime"] ? moment(data["expirationTime"].toString()) : <any>undefined;
            this.questionClassfy = data["questionClassfy"];
            this.dutyer = data["dutyer"];
            this.tag = data["tag"];
            this.source = data["source"];
            if (data["viewList"] && data["viewList"].constructor === Array) {
                this.viewList = [];
                for (let item of data["viewList"])
                    this.viewList.push(item);
            }
            if (data["imgList"] && data["imgList"].constructor === Array) {
                this.imgList = [];
    ...
    static fromJS(data: any): CreateTaskUnitInput {
        let result = new CreateTaskUnitInput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["questionClassfy"] = this.questionClassfy;
        data["dutyer"] = this.dutyer;
        data["tag"] = this.tag;
        data["source"] = this.source;
        if (this.viewList && this.viewList.constructor === Array) {
            data["viewList"] = [];
            for (let item of this.viewList)
                data["viewList"].push(item);
        }
        if (this.imgList && this.imgList.constructor === Array) {
            data["imgList"] = [];
...
export interface ICreateTaskUnitInput {
    title: string;
    description: string;
    priority: number;
    expirationTime: moment.Moment;
...
export class TaskUnitListDto implements ITaskUnitListDto {
    title: string;
    description: string;
    priority: number;
    state: number;
    ...
    constructor(data?: ITaskUnitListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.source = data["source"];
            this.creatorUserName = data["creatorUserName"];
            this.creatorUserPost = data["creatorUserPost"];
            this.modifierUserName = data["modifierUserName"];
            this.dutyerName = data["dutyerName"];
            if (data["viewList"] && data["viewList"].constructor === Array) {
                this.viewList = [];
                for (let item of data["viewList"])
                    this.viewList.push(item);
    ...
    static fromJS(data: any): TaskUnitListDto {
        let result = new TaskUnitListDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["source"] = this.source;
        data["creatorUserName"] = this.creatorUserName;
        data["creatorUserPost"] = this.creatorUserPost;
        data["modifierUserName"] = this.modifierUserName;
        data["dutyerName"] = this.dutyerName;
        if (this.viewList && this.viewList.constructor === Array) {
            data["viewList"] = [];
            for (let item of this.viewList)
                data["viewList"].push(item);
...
export interface ITaskUnitListDto {
    title: string;
    description: string;
    priority: number;
    state: number;
...
export class PagedResultDtoOfTaskUnitListDto implements IPagedResultDtoOfTaskUnitListDto {
    totalCount: number;
    items: TaskUnitListDto[];

    constructor(data?: IPagedResultDtoOfTaskUnitListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(TaskUnitListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfTaskUnitListDto {
        let result = new PagedResultDtoOfTaskUnitListDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfTaskUnitListDto {
    totalCount: number;
    items: TaskUnitListDto[];
}

export class ListResultDtoOfTaskUnitListDto implements IListResultDtoOfTaskUnitListDto {
    items: TaskUnitListDto[];

    constructor(data?: IListResultDtoOfTaskUnitListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ListResultDtoOfTaskUnitListDto {
        let result = new ListResultDtoOfTaskUnitListDto();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfTaskUnitListDto {
    items: TaskUnitListDto[];
}

export class ListResultDtoOfRelativeViewListDto implements IListResultDtoOfRelativeViewListDto {
    items: RelativeViewListDto[];

    constructor(data?: IListResultDtoOfRelativeViewListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(RelativeViewListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfRelativeViewListDto {
        let result = new ListResultDtoOfRelativeViewListDto();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfRelativeViewListDto {
    items: RelativeViewListDto[];
}

export class RelativeViewListDto implements IRelativeViewListDto {
    bytes: string;
    taskId: string;
    viewId: string;
    id: number;
    ...
    constructor(data?: IRelativeViewListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.id = data["id"];
            this.strBytes = data["strBytes"];
        }
    }

    static fromJS(data: any): RelativeViewListDto {
        let result = new RelativeViewListDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["id"] = this.id;
        data["strBytes"] = this.strBytes;
        return data;
    }
}

export interface IRelativeViewListDto {
    bytes: string;
    taskId: string;
    viewId: string;
    id: number;
...
export class ListResultDtoOfTaskUnitOrViewLogListDto implements IListResultDtoOfTaskUnitOrViewLogListDto {
    items: TaskUnitOrViewLogListDto[];

    constructor(data?: IListResultDtoOfTaskUnitOrViewLogListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(TaskUnitOrViewLogListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfTaskUnitOrViewLogListDto {
        let result = new ListResultDtoOfTaskUnitOrViewLogListDto();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfTaskUnitOrViewLogListDto {
    items: TaskUnitOrViewLogListDto[];
}

export class TaskUnitOrViewLogListDto implements ITaskUnitOrViewLogListDto {
    content: string;
    taskId: string;
    viewId: string;
    type: string;
    ...
    creatorUserPost: string;
    profilePictureId: string;
    creatorUserBytes: string;

    constructor(data?: ITaskUnitOrViewLogListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.creatorUserPost = data["creatorUserPost"];
            this.profilePictureId = data["profilePictureId"];
            this.creatorUserBytes = data["creatorUserBytes"];
        }
    }

    static fromJS(data: any): TaskUnitOrViewLogListDto {
        let result = new TaskUnitOrViewLogListDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["creatorUserPost"] = this.creatorUserPost;
        data["profilePictureId"] = this.profilePictureId;
        data["creatorUserBytes"] = this.creatorUserBytes;
        return data;
    }
}

export interface ITaskUnitOrViewLogListDto {
    content: string;
    taskId: string;
    viewId: string;
    type: string;
...
export class CreateTaskOrViewLogInput implements ICreateTaskOrViewLogInput {
    content: string;
    taskId: string;
    viewId: string;

    constructor(data?: ICreateTaskOrViewLogInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateTaskOrViewLogInput {
        let result = new CreateTaskOrViewLogInput();
        result.init(data);
        return result;
    }
...
export interface ICreateTaskOrViewLogInput {
    content: string;
    taskId: string;
    viewId: string;
}

export class EditTaskUnitInput implements IEditTaskUnitInput {
    description: string;
    priority: number;
    expirationTime: moment.Moment;
    questionClassfy: string;
    ...
    constructor(data?: IEditTaskUnitInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): EditTaskUnitInput {
        let result = new EditTaskUnitInput();
        result.init(data);
        return result;
    }
...
export interface IEditTaskUnitInput {
    description: string;
    priority: number;
    expirationTime: moment.Moment;
    questionClassfy: string;
...
export class CreateTaskViewInput implements ICreateTaskViewInput {
    name: string;
    thumbnail: string;
    source: string;
    sourceId: string;
    ...
    constructor(data?: ICreateTaskViewInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.description = data["description"];
            if (data["shareUsersList"] && data["shareUsersList"].constructor === Array) {
                this.shareUsersList = [];
                for (let item of data["shareUsersList"])
                    this.shareUsersList.push(item);
            }
            this.markPageIndex = data["markPageIndex"];
            this.markContent = data["markContent"];
        }
    }

    static fromJS(data: any): CreateTaskViewInput {
        let result = new CreateTaskViewInput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["description"] = this.description;
        if (this.shareUsersList && this.shareUsersList.constructor === Array) {
            data["shareUsersList"] = [];
            for (let item of this.shareUsersList)
                data["shareUsersList"].push(item);
        }
        data["markPageIndex"] = this.markPageIndex;
...
export class TaskViewListDto implements ITaskViewListDto {
    name: string;
    description: string;
    bytes: string;
    source: string;
    ...
    constructor(data?: ITaskViewListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.source = data["source"];
            this.sourceId = data["sourceId"];
            this.sourceRelative = data["sourceRelative"];
            this.creatorUserName = data["creatorUserName"];
            this.creatorUserPost = data["creatorUserPost"];
            this.strBytes = data["strBytes"];
            this.markPageIndex = data["markPageIndex"];
    ...
    static fromJS(data: any): TaskViewListDto {
        let result = new TaskViewListDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["source"] = this.source;
        data["sourceId"] = this.sourceId;
        data["sourceRelative"] = this.sourceRelative;
        data["creatorUserName"] = this.creatorUserName;
        data["creatorUserPost"] = this.creatorUserPost;
        data["strBytes"] = this.strBytes;
        data["markPageIndex"] = this.markPageIndex;
...
export interface ITaskViewListDto {
    name: string;
    description: string;
    bytes: string;
    source: string;
...
export class PagedResultDtoOfTaskViewListDto implements IPagedResultDtoOfTaskViewListDto {
    totalCount: number;
    items: TaskViewListDto[];

    constructor(data?: IPagedResultDtoOfTaskViewListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(TaskViewListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfTaskViewListDto {
        let result = new PagedResultDtoOfTaskViewListDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfTaskViewListDto {
    totalCount: number;
    items: TaskViewListDto[];
}

export class ListResultDtoOfTaskViewListDto implements IListResultDtoOfTaskViewListDto {
    items: TaskViewListDto[];

    constructor(data?: IListResultDtoOfTaskViewListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ListResultDtoOfTaskViewListDto {
        let result = new ListResultDtoOfTaskViewListDto();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfTaskViewListDto {
    items: TaskViewListDto[];
}

export class ListResultDtoOfViewShareUserListDto implements IListResultDtoOfViewShareUserListDto {
    items: ViewShareUserListDto[];

    constructor(data?: IListResultDtoOfViewShareUserListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(ViewShareUserListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfViewShareUserListDto {
        let result = new ListResultDtoOfViewShareUserListDto();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfViewShareUserListDto {
    items: ViewShareUserListDto[];
}

export class ViewShareUserListDto implements IViewShareUserListDto {
    userId: number;
    viewId: string;
    userName: string;
    id: number;

    constructor(data?: IViewShareUserListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ViewShareUserListDto {
        let result = new ViewShareUserListDto();
        result.init(data);
        return result;
    }
...
export interface IViewShareUserListDto {
    userId: number;
    viewId: string;
    userName: string;
    id: number;
...
export class TenantListDto implements ITenantListDto {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.strCorporation = data["strCorporation"];
            this.completedTime = data["completedTime"] ? moment(data["completedTime"].toString()) : <any>undefined;
            this.location = data["location"];
            this.coveredArea = data["coveredArea"];
            this.remark = data["remark"];
            this.userID = data["userID"];
            this.tenantDetailId = data["tenantDetailId"];
            this.sourceType = data["sourceType"];
            this.tenantDetails = data["tenantDetails"] ? TenantDetail.fromJS(data["tenantDetails"]) : <any>undefined;
            this.thumbnail = data["thumbnail"];
            this.id = data["id"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["strCorporation"] = this.strCorporation;
        ...
        data["userID"] = this.userID;
        data["tenantDetailId"] = this.tenantDetailId;
        data["sourceType"] = this.sourceType;
        data["tenantDetails"] = this.tenantDetails ? this.tenantDetails.toJSON() : <any>undefined;
        data["thumbnail"] = this.thumbnail;
        data["id"] = this.id;
        return data;
    }
...
export class TenantDetail implements ITenantDetail {
    ...
    volume_Construction_Area: number;
    up_Construction_Area: number;
    under_Construction_Area: number;
    total_Sale_Area: number;
    plot_Ratio: number;
    project_Intro: string;
    project_Section: string;
    location: string;
    position: string;
    project_Periphery: string;
    product_Door_Type: string;
    ...
    constructor(data?: ITenantDetail) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.belong_Provinces = data["belong_Provinces"];
            this.belong_City = data["belong_City"];
            this.belong_Region = data["belong_Region"];
            this.belong_Company = data["belong_Company"];
            this.stage_Count = data["stage_Count"];
            this.project_Address = data["project_Address"];
            this.total_Area = data["total_Area"];
            this.construction_Area = data["construction_Area"];
            this.total_Construction_Area = data["total_Construction_Area"];
            this.volume_Construction_Area = data["volume_Construction_Area"];
            this.up_Construction_Area = data["up_Construction_Area"];
            this.under_Construction_Area = data["under_Construction_Area"];
            this.total_Sale_Area = data["total_Sale_Area"];
            this.plot_Ratio = data["plot_Ratio"];
            this.project_Intro = data["project_Intro"];
            this.project_Section = data["project_Section"];
            this.location = data["location"];
            this.position = data["position"];
            this.project_Periphery = data["project_Periphery"];
            this.product_Door_Type = data["product_Door_Type"];
    ...
    static fromJS(data: any): TenantDetail {
        let result = new TenantDetail();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["belong_Provinces"] = this.belong_Provinces;
        data["belong_City"] = this.belong_City;
        data["belong_Region"] = this.belong_Region;
        data["belong_Company"] = this.belong_Company;
        data["stage_Count"] = this.stage_Count;
        data["project_Address"] = this.project_Address;
        data["total_Area"] = this.total_Area;
        data["construction_Area"] = this.construction_Area;
        data["total_Construction_Area"] = this.total_Construction_Area;
        data["volume_Construction_Area"] = this.volume_Construction_Area;
        data["up_Construction_Area"] = this.up_Construction_Area;
        data["under_Construction_Area"] = this.under_Construction_Area;
        data["total_Sale_Area"] = this.total_Sale_Area;
        data["plot_Ratio"] = this.plot_Ratio;
        data["project_Intro"] = this.project_Intro;
        data["project_Section"] = this.project_Section;
        data["location"] = this.location;
        data["position"] = this.position;
        data["project_Periphery"] = this.project_Periphery;
        data["product_Door_Type"] = this.product_Door_Type;
        data["project_Manager"] = this.project_Manager;
        data["isDeleted"] = this.isDeleted;
        data["deleterUserId"] = this.deleterUserId;
        data["deletionTime"] = this.deletionTime ? this.deletionTime.toISOString() : <any>undefined;
        data["lastModificationTime"] = this.lastModificationTime ? this.lastModificationTime.toISOString() : <any>undefined;
...
export class ListResultDtoOfTenantListDto implements IListResultDtoOfTenantListDto {
    items: TenantListDto[];

    constructor(data?: IListResultDtoOfTenantListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ListResultDtoOfTenantListDto {
        let result = new ListResultDtoOfTenantListDto();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfTenantListDto {
    items: TenantListDto[];
}
...
export class CreateTenantInput implements ICreateTenantInput {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.remark = data["remark"];
            this.pk_Project = data["pk_Project"];
            if (data["regionList"] && data["regionList"].constructor === Array) {
                this.regionList = [];
                for (let item of data["regionList"])
    ...
    toJSON(data?: any) {
        ...
        data["remark"] = this.remark;
        data["pk_Project"] = this.pk_Project;
        if (this.regionList && this.regionList.constructor === Array) {
            data["regionList"] = [];
